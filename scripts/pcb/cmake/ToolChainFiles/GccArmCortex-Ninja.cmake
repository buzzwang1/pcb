...
if (NOT PCB_ToolchainInstalled)
  ...
  if ("${DIR_GNU_ARM_CORTEX}" STREQUAL "")
    SET(DIR_GNU_ARM_CORTEX "${PCB_ProjCfg_system_dir_tools}/gcc/Arm/bin/")
  endif()
  message(STATUS "Build tool: ${DIR_GNU_ARM_CORTEX}")
  ...
  #SET(CMAKE_AR                          ${DIR_GNU_ARM_CORTEX}arm-none-eabi-ar.exe       CACHE FILEPATH "" FORCE)
  SET(CMAKE_C_COMPILER                  "${DIR_GNU_ARM_CORTEX}arm-none-eabi-gcc.exe"     CACHE FILEPATH "" FORCE)
  SET(CMAKE_CXX_COMPILER                "${DIR_GNU_ARM_CORTEX}arm-none-eabi-g++.exe"     CACHE FILEPATH "" FORCE)
  #SET(CMAKE_ASM_COMPILER                ${DIR_GNU_ARM_CORTEX}arm-none-eabi-as.exe       CACHE FILEPATH "" FORCE)
  #SET(CMAKE_LINKER                      ${DIR_GNU_ARM_CORTEX}arm-none-eabi-ld.exe       CACHE FILEPATH "" FORCE)
  #SET(CMAKE_NM                          ${DIR_GNU_ARM_CORTEX}arm-none-eabi-nm.exe       CACHE FILEPATH "" FORCE)
  #SET(CMAKE_OBJDUMP                     ${DIR_GNU_ARM_CORTEX}arm-none-eabi-objdump.exe  CACHE FILEPATH "" FORCE)
  #SET(CMAKE_STRIP                       ${DIR_GNU_ARM_CORTEX}arm-none-eabi-strip.exe    CACHE FILEPATH "" FORCE)
  #SET(CMAKE_SIZE                        ${DIR_GNU_ARM_CORTEX}arm-none-eabi-size.exe     CACHE FILEPATH "" FORCE)
