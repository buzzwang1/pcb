...
::Uncomment for test
::@echo TcArgCount=%TcArgCount% variant=%TcVariant% selectionmode=%TcSelectionMode%

:: ToolCaller Commands 
set TcCmds=Projects/ExportCfgCm
set TcCmds=%TcCmds%;tools/create_vs2017_json/subscript/call
...
:error
@echo failure in VS2017_Pre.bat
@set  PATH=%PathSave%
@exit /B 1