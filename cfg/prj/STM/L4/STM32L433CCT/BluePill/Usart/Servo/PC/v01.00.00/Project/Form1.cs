...
namespace Project
{
  public partial class Form1 : Form
  {
    ...
    public void ComPort_vProcess(Queue<cComPort_Entry> ComPort_lcQueueRx, Queue<cComPort_Entry> ComPort_lcQueueTx)
    {
      bool lbRepeat;
      long lRxTimeStamp = 0;
      long lRxTimeStamp2 = 0;
      long lRxTimeStamp3 = 0;
      ...
      while (true)
      {
        if (ComPort.IsOpen)
        {
          do
          {
            ...
            {
              lRxTimeStamp2 = ComPort_mcTimestamp.ElapsedMilliseconds;
            ...
            lRxTimeStamp3 =  ComPort_mcTimestamp.ElapsedMilliseconds;

            if ((lRxTimeStamp3 - lRxTimeStamp2 > 5) && (lRxTimeStamp2 != 0))
            {
