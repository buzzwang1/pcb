...
if not exist .\source\Driver\STM32\U5\HAL\v01.01.00\HAL\_var\lib_og\libhal_lib_og.a (
  @echo on
  call build STM/U5/HalLib/v01.01.00.Og first
  @echo.  
  @echo copy /Y .\bin\STM\U5\HalLib\v01.01.00\Og\cmake\lib\libhal_lib.a .\source\Driver\STM32\U5\HAL\v01.01.00\HAL\_var\lib_og\libhal_lib_og.a
  call copy /Y .\bin\STM\U5\HalLib\v01.01.00\Og\cmake\lib\libhal_lib.a .\source\Driver\STM32\U5\HAL\v01.01.00\HAL\_var\lib_og\libhal_lib_og.a
  @echo off
) else (
  @echo STM/U5/HalLib/v01.01.00.Og skipped
)


if not exist .\source\Driver\STM32\U5\HAL\v01.01.00\HAL\_var\lib_o3\libhal_lib_o3.a (
  @echo on
  call build STM/U5/HalLib/v01.01.00.O3 first
  @echo.  
  @echo copy /Y .\bin\STM\U5\HalLib\v01.01.00\O3\cmake\lib\libhal_lib.a .\source\Driver\STM32\U5\HAL\v01.01.00\HAL\_var\lib_o3\libhal_lib_o3.a
  call copy /Y .\bin\STM\U5\HalLib\v01.01.00\O3\cmake\lib\libhal_lib.a .\source\Driver\STM32\U5\HAL\v01.01.00\HAL\_var\lib_o3\libhal_lib_o3.a
  @echo off
) else (
  @echo STM/U5/HalLib/v01.01.00.O3 skipped
)

if not exist .\source\Driver\STM32\U5\HAL\v01.01.00\HAL\_var\lib_os\libhal_lib_os.a (
  @echo on
  call build STM/U5/HalLib/v01.01.00.Os first
  @echo.  
  @echo copy /Y .\bin\STM\U5\HalLib\v01.01.00\Os\cmake\lib\libhal_lib.a .\source\Driver\STM32\U5\HAL\v01.01.00\HAL\_var\lib_os\libhal_lib_os.a
  call copy /Y .\bin\STM\U5\HalLib\v01.01.00\Os\cmake\lib\libhal_lib.a .\source\Driver\STM32\U5\HAL\v01.01.00\HAL\_var\lib_os\libhal_lib_os.a
  @echo off
) else (
  @echo STM/U5/HalLib/v01.01.00.Os skipped
)
