...
bool cBotNet::bAddLink(UsgUplink* lcLink)
{
...
bool cBotNet::bAddLink(UsgUplink* lcLink, u16 lu16Adr)
{
...
void cBotNet::vLinkSync(UsgUplink* lpcLink, bool lbForceSync)
{
  UNUSED(lpcLink);
  UNUSED(lbForceSync);

  // Uplink hat kein Sync
  //if (lpcLink != null)
  //{
...
void cBotNet::vForwardMsgToLink(UsgUplink* lpcLink, u8& lu8PoolIdx)
{
  if (lpcLink)
  {
