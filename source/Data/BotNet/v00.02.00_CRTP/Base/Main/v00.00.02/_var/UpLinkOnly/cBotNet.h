...
class cBotNet
{
  ...
  using UsgUplink = cBotNet_LinkBase2<tenBotNet_LinkBase2_Type::enUpLink, True>;
  ...
  bool bAddLink(UsgUplink* lcLink);
  bool bAddLink(UsgUplink* lcLink, u16 lu16Adr);
  void vLinkSync(UsgUplink* lpcLink, bool lbForceSync);
  ...
  void vForwardMsgToLink(UsgUplink* lpcLink, u8 &lu8PoolIdx);
