...
#define cBotNet_MsgPool16B     0 // 20 Byte; 16 + 1 + 3 
#define cBotNet_MsgPool32B    12 // 36 Byte; 32 + 1 + 3
#define cBotNet_MsgPool64B    12 // 72 Byte; 65 + 1 + 6

#define cBotNet_DownLinkCnt          0

#define cBotNet_DownLinkSyncAll      1000 // [ms] Es werden alles gesyncht, sonst nur die Online

#define cBotNet_StreamSysPortsCnt           1
...
public:
  typedef enum
  {
    ...
    enCnstWait75us  =  75,
    enCnstWait100us = 100,
    enCnstWaitTSyncUp   = enCnstNoDelay,
    enCnstWaitTDataUp   = enCnstNoDelay,
    enCnstWaitTSyncDwn  = enCnstNoDelay,
    enCnstWaitTDataDwn  = enCnstNoDelay,
    enCnstWaitEndDwn    = enCnstNoDelay,
  }tenConsts;
};
