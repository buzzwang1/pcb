...
void cBnSpop_vStartTim15()
{
  ...
  TimHandle.Init.Prescaler = (24000) - 1; // 1ms
  ...
  HAL_NVIC_SetPriority(TIM1_BRK_TIM15_IRQn, 6, 8);  // Höhere Prio,wegen Asynchron
  /* Enable the TIM15 global Interrupt */
...
void cBnSpop_vFlash_ErasePage_Start(uint8* lpui8PageStartAdress)
{
  ...
  if (!cBnSpop_isFlash_Busy())
  {
    ...
    u32 lu32Page = (u32)lpui8PageStartAdress - 0x08000000;
    lu32Page >>= 11; // /= 2048;

    MODIFY_REG(FLASH->CR, FLASH_CR_PNB, ((lu32Page & 0xFFU) << FLASH_CR_PNB_Pos));
  ...
  if (!cBnSpop_isFlash_Busy())
  {
    ...
    while (lui32Size > 0)
    {
      ...
      *(u32*)lpui8Adress = (u32)lu64Data;
      ...
      /* Program second word */
      *(u32*)(lpui8Adress + 4U) = (u32)(lu64Data >> 32);
...
bool cBnSpop_isFlash_Error()
{
  ...
  lu32Error = (FLASH->SR & FLASH_FLAG_SR_ERRORS);
