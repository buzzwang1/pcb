...
set(gen_pkg_name "cBotNetBaseApp")

# List of all source files found in the packages filetree
set (gen_files 
	# List of all source files found in gen_files
	# List of all source files found in UpLinkOnly_gen_files
	./_var/UpLinkOnly/cBotNet.cpp
)
...
set (gen_headers 
	...
	# List of all source files found in UpLinkOnly_gen_headers
	./_var/UpLinkOnly/cBotNet.h
)
...
set (gen_asmfiles 
	...
	# List of all source files found in UpLinkOnly_gen_asmfiles
)
...
set (gen_include_directories 
	...
	# List of all source files found in UpLinkOnly_gen_include_directories
	./_var/UpLinkOnly
)
