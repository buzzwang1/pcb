...
class cBotNetMsg_Base : public cbArrayExtT<uint16>
{
  ...
  void vDecode()
  {
    ...
    *lu8Dst = *lu8Src;
    ...
    {
      // RiscV kann u16 Zugriff nur von aligned Adressen
      // Daher byteweise zugreifen
      u8 lu8AdrHB;
      u8 lu8AdrLB;
      lu8Src--; lu8AdrLB = *lu8Src;
      lu8Src--; lu8AdrHB = *lu8Src;
      lu8Dst--; *lu8Dst = lu8AdrHB;
      lu8Dst--; *lu8Dst = lu8AdrLB;
      lu8Src--; lu8AdrLB = *lu8Src;
      lu8Src--; lu8AdrHB = *lu8Src;
      lu8Dst--; *lu8Dst = lu8AdrHB;
      lu8Dst--; *lu8Dst = lu8AdrLB;
  ...
  void vEncode(u8 lu8PayloadSize)  // __attribute__((optimize("O0")))
  {
    ...
    *lu8Dst = *lu8Src;
    ...
    if (mcFrame.mstControl.AdrIntOn)
    {
      // RiscV kann u16 Zugriff nur von aligned Adressen
      // Daher byteweise zugreifen
      lu8Dst--; *lu8Dst = (u8)(mcFrame.mcSAdr.mAdr.u16Adr & 0xFF);
      lu8Dst--; *lu8Dst = (u8)(mcFrame.mcSAdr.mAdr.u16Adr >> 8);
      lu8Dst--; *lu8Dst = (u8)(mcFrame.mcDAdr.mAdr.u16Adr & 0xFF);
      lu8Dst--; *lu8Dst = (u8)(mcFrame.mcDAdr.mAdr.u16Adr >> 8);
    }
  }
