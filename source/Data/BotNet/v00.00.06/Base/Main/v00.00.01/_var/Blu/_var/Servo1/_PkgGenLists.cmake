...
set(gen_pkg_name "cBotNetMain")

# List of all source files found in the packages filetree
set (gen_files 
	# List of all source files found in gen_files
	# List of all source files found in Blu_gen_files
	# List of all source files found in Blu_Servo1_gen_files
	./_var/Blu/_var/Servo1/cBotNet.cpp
)
...
set (gen_headers 
	...
	# List of all source files found in Blu_gen_headers
	# List of all source files found in Blu_Servo1_gen_headers
	./_var/Blu/_var/Servo1/cBotNet.h
)
...
set (gen_asmfiles 
	...
	# List of all source files found in Blu_gen_asmfiles
	# List of all source files found in Blu_Servo1_gen_asmfiles
)
...
set (gen_include_directories 
	...
	# List of all source files found in Blu_gen_include_directories
	# List of all source files found in Blu_Servo1_gen_include_directories
	./_var/Blu/_var/Servo1
)
