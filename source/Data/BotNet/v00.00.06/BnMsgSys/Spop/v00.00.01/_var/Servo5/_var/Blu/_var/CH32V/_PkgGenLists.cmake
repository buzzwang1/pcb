...
set(gen_pkg_name "cBotNetMsgSysSpop")

# List of all source files found in the packages filetree
set (gen_files 
	# List of all source files found in gen_files
	# List of all source files found in Servo5_gen_files
	# List of all source files found in Servo5_Blu_gen_files
	# List of all source files found in Servo5_Blu_cH32V_gen_files
	./_var/Servo5/_var/Blu/_var/cH32V/cBnMsgSysSpop.cpp
)
...
set (gen_headers 
	...
	# List of all source files found in Servo5_gen_headers
	# List of all source files found in Servo5_Blu_gen_headers
	# List of all source files found in Servo5_Blu_cH32V_gen_headers
	./_var/Servo5/_var/Blu/_var/cH32V/cBnMsgSysSpop.h
)
...
set (gen_asmfiles 
	...
	# List of all source files found in Servo5_gen_asmfiles
	# List of all source files found in Servo5_Blu_gen_asmfiles
	# List of all source files found in Servo5_Blu_cH32V_gen_asmfiles
)
...
set (gen_include_directories 
	...
	# List of all source files found in Servo5_gen_include_directories
	# List of all source files found in Servo5_Blu_gen_include_directories
	# List of all source files found in Servo5_Blu_cH32V_gen_include_directories
	./_var/Servo5/_var/Blu/_var/cH32V
)
