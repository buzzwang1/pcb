...
#define cBotNet_MsgPool16B     4
#define cBotNet_MsgPool32B     8
#define cBotNet_MsgPool64B    12
...
#define cBnMsgSysBtrCfgRamSize            (1*1024)
...
public:
  typedef enum
  {
    ...
    enCnstWait75us  =  75,
    enCnstWait100us = 100,
    enCnstWaitRSyncUp   = enCnstWait25us,
