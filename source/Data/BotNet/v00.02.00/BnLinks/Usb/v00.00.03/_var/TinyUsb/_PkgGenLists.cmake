...
set(gen_pkg_name "cBotNetLinkUsb")

# List of all source files found in the packages filetree
set (gen_files 
	# List of all source files found in gen_files
	# List of all source files found in TinyUsb_gen_files
	./_var/TinyUsb/cBnLinkUsb.cpp
)
...
set (gen_headers 
	...
	# List of all source files found in TinyUsb_gen_headers
	./_var/TinyUsb/cBnLinkUsb.h
)
...
set (gen_asmfiles 
	...
	# List of all source files found in TinyUsb_gen_asmfiles
)
...
set (gen_include_directories 
	...
	# List of all source files found in TinyUsb_gen_include_directories
	./_var/TinyUsb
)
