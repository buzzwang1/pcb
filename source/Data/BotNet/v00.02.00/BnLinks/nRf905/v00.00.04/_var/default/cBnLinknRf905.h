...
public:
  cBotNet_DownLinkNrf905(cComNodeMaster* lcDownLink)
    : cBotNet_DownLink(lcDownLink, cNRF905Bn::NRF905_WAIT_TX_DELAY, cNRF905Bn::NRF905_WAIT_TX_DELAY, False)
  {}
};

// -------------------------------------------------------------------------------------------

class cBotNet_UpLinkNrf905 : public cBotNet_UpLink<0, cNRF905Bn::NRF905_WAIT_TX_DELAY, cNRF905Bn::NRF905_WAIT_TX_DELAY, False>
{
public:
