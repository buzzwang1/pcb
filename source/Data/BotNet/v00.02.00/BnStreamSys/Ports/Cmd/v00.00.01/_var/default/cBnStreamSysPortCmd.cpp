...
cBotNetStreamPort_BotNetCmdPort::cBotNetStreamPort_BotNetCmdPort(cBotNet* lcBotNet)
 : cCli(&mcRxRingBuf, &mcTextOut, null, 2, (void*)lcBotNet),
   mcCliCmdList(mcCliCmds, 5),
   mcTextOut(mpui8TextBufOut, 512)
{
  mszName = (const char8*)"BnCmdPort v01.00.02";

  mcCliCmds[0] = &mcCliCmd_Ver;
  mcCliCmds[1] = &mcCliCmd_Help;
  mcCliCmds[2] = &mcCliCmd_Ports;

  mcCliCmds[3] = &mcCliCmd_Links;
  mcCliCmds[4] = &mcCliCmd_Status;
  
  cCli::mcCmdList = &mcCliCmdList;
