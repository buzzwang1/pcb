...
set(gen_pkg_name "cBotNetMsgSysMView")

# List of all source files found in the packages filetree
set (gen_files 
	# List of all source files found in gen_files
	# List of all source files found in Small_gen_files
	./_var/Small/cBnMsgSysMView.cpp
)
...
set (gen_headers 
	...
	# List of all source files found in Small_gen_headers
	./_var/Small/cBnMsgSysMView.h
)
...
set (gen_asmfiles 
	...
	# List of all source files found in Small_gen_asmfiles
)
...
set (gen_include_directories 
	...
	# List of all source files found in Small_gen_include_directories
	./_var/Small
)
