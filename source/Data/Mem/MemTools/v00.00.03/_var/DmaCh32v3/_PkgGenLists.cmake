...
set (gen_files 
	...
	./MemTools.cpp
	# List of all source files found in DmaCh32v3_gen_files
	./_var/DmaCh32v3/MemToolsHw.cpp
)
...
set (gen_headers 
	...
	./MemTools.h
	# List of all source files found in DmaCh32v3_gen_headers
	./_var/DmaCh32v3/MemToolsHw.h
)
...
set (gen_asmfiles 
	...
	# List of all source files found in DmaCh32v3_gen_asmfiles
)
...
set (gen_include_directories 
	...
	.
	# List of all source files found in DmaCh32v3_gen_include_directories
	./_var/DmaCh32v3
)
