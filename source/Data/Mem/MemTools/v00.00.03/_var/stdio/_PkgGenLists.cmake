...
set (gen_files 
	...
	./MemTools.cpp
	# List of all source files found in stdio_gen_files
	./_var/stdio/MemToolsHw.cpp
)
...
set (gen_headers 
	...
	./MemTools.h
	# List of all source files found in stdio_gen_headers
	./_var/stdio/MemToolsHw.h
)
...
set (gen_asmfiles 
	...
	# List of all source files found in stdio_gen_asmfiles
)
...
set (gen_include_directories 
	...
	.
	# List of all source files found in stdio_gen_include_directories
	./_var/stdio
)
