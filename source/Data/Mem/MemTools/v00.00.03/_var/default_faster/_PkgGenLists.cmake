...
set(gen_pkg_name "memtools")

# List of all source files found in the packages filetree
set (gen_files 
	# List of all source files found in gen_files
	./MemTools.cpp
	# List of all source files found in default_faster_gen_files
	./_var/default_faster/MemToolsHw.cpp
)
...
set (gen_headers 
	...
	./MemTools.h
	# List of all source files found in default_faster_gen_headers
	./_var/default_faster/MemToolsHw.h
)
...
set (gen_asmfiles 
	...
	# List of all source files found in default_faster_gen_asmfiles
)
...
set (gen_include_directories 
	...
	.
	# List of all source files found in default_faster_gen_include_directories
	./_var/default_faster
)
