...
#define ROMCONST_PARTITION_SIZE_APP (  2 * 1024)
#define ROMCONST_PARTITION_SIZE_IMG ROMCONST_PARTITION_SIZE_APP
#define ROMCONST_PARTITION_SIZE_BL  ( 14 * 1024 - 512)
#define ROMCONST_PARTITION_SIZE_EEP (  512)

#define ROMCONST_PARTITION_START_ADRESS_FLASH (u8*)(0x00000000)
...
#define RomConst_Platform_Ram_Size   (512) //(*(u32*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0x004C))
...
typedef struct
{
  ...
  u32   u32IAP_RamSize;                    //
                                           //
  // 16 Partitionen                        //
  tstMemPart_Partition stPartitions[8];    // 0x0050   3*32 = 0x60
                                           // 
  // End of Device Info Block              // 0x00B0
  u8    u8UserData[ROMCONST_PARTITION_SIZE_EEP - 0x0B0 - 8];
  u32   u32Checksum;
  u32   u32MagicPattern;
