...
SetHeader("Servo1", "GD32L130G6", "Cortex-M3,Rom 32KB,Ram 4KB",  0, 0x1100, 5, 256)

SetPartition(0, "Flash APP",  16, 0, 0x08000000,                       18*1024, 0x0400)
SetPartition(1, "Flash Bl",   16, 0, 0x08000000 +  18 * 1024,          13*1024, 0x0400)
SetPartition(2, "Flash IMG",  16, 0, 0x08000000,                       18*1024, 0x0400)
SetPartition(3, "Flash EEP",  16, 0, 0x08000000 +  (18 + 13) * 1024,    1*1024, 0x0400)
...
newFile = open("RomConst_0x08007C00.bin", "wb")
