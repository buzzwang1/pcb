...
#define rszGetRomConstDeviceName()           ((rsz)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X0000))           // Defaultvalue MBv4b4 
...
#define fGetRomConstP_In()                   (*((float*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X023E)))     // Defaultvalue 0.01:  P_In
#define fGetRomConstKp()                     (*((float*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X0242)))     // Defaultvalue 1.0:   Kp
#define fGetRomConstKi()                     (*((float*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X0246)))     // Defaultvalue 1.0:   Ki
#define fGetRomConstKd()                     (*((float*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X024A)))     // Defaultvalue 1.0:   Kd
#define fGetRomConstP_Out()                  (*((float*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X024E)))     // Defaultvalue 0.01:  P_Out
#define fGetRomConstReserve1()               (*((float*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X0252)))     // Defaultvalue 1.0:   Reserve1
#define fGetRomConstReserve2()               (*((float*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X0256)))     // Defaultvalue 1.0:   Reserve2
#define fGetRomConstReserve3()               (*((float*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X025A)))     // Defaultvalue 1.0:   Reserve3
#define u16GetRomConstVoltLipoOff()          (*((u16*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X025E)))       // Defaultvalue 3000:  VoltLipoOff [mV]        Tiefentladeschutz. Bei der Spannung schaltet sich der uC ab. Versorgung zur Lipo wird getrennt
#define u16GetRomConstVoltSysOff()           (*((u16*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X0260)))       // Defaultvalue 3150:  VoltSysOff [mV]         Unterspannungsschutz. Bei der Spannung wird der Ausgang ausgeschaltet und der uC geht in  den Stromsparmodus
#define u16GetRomConstMaxVoltCell()          (*((u16*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X0262)))       // Defaultvalue 3550:  MaxVoltCell [mV]        Ladeschlussspannung. Bei der Spannung ist die Lipo geladen
#define u16GetRomConstVoltBalance()          (*((u16*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X0264)))       // Defaultvalue 3650:  VoltBalance [mV]        Balancespannung. Bei der Spannung wird beim Laden der Balancer der Zelle aktiviert
#define u16GetRomConstMpptVoltInput()        (*((u16*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X0266)))       // Defaultvalue 5000:  MPPT_VoltInput [mV]     MPPT Eingangsspannung. Bei MPPT wird versucht die Eingangsspannung auf diesen Level zu halten.
#define u16GetRomConstCurrentSave()          (*((u16*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X0268)))       // Defaultvalue 25:    CurrentSave [mA]        Sichere Ladestrom. Ladestrom bei tiefentladener Zelle oder wenn Balancer einer Zelle an ist.
#define u16GetRomConstMaxCurrentBat()        (*((u16*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X026A)))       // Defaultvalue 100:   MaxCurrentBat [mA]      Ladestrombegrenzung. Maximaler Ladestrom der Akku.
#define u16GetRomConstMaxCurrentInput()      (*((u16*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X026C)))       // Defaultvalue 500:   MaxCurrentInput [mA]    Eingangsstrombegrenzung. Maximaler Eingangsstrom = Eingangsboostfaktor x MaxCurrentBat + Strom des Systems
#define u16GetRomConstVoltCellDefect()       (*((u16*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X026E)))       // Defaultvalue 2000:  VoltCellDefect [mV]     Defektspannung. Bei dieser Spannung wird die Zelle als defekt erkannt und die Versorgung zur Lipo wird getrennt
#define u16GetRomConstVoltMinPowerIn()       (*((u16*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X0270)))       // Defaultvalue 10000: VoltMinPowerIn [mV]     Minnimale Boostspannung
#define u16GetRomConstVoltMaxPowerIn()       (*((u16*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X0272)))       // Defaultvalue 14600: VoltMaxPowerIn [mV]     Maximale Boostspannung
#define u16GetRomConstVoltPowerInCharged()   (*((u16*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X0274)))       // Defaultvalue 100:   VoltPowerInCharged [mV] Erhaltungsspannung. Sobald Lipo fertig geladen ist, wird diese Spannung eingestellt
#define u16GetRomConstTimeOut1()             (*((u16*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X0276)))       // Defaultvalue 2000:  TimeOut1 [ms]           Timeout: Ein Spannung muss diese Zeit anliegen um gultig zu werden, z.B. Ladeschlussspannung
#define u16GetRomConstTimeOut2()             (*((u16*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X0278)))       // Defaultvalue 1000:  TimeOut2 [ms]
#define u16GetRomConstTimeOut3()             (*((u16*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X027A)))       // Defaultvalue 500:   TimeOut3 [ms]
#define u16GetRomConstTimeOut4()             (*((u16*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X027C)))       // Defaultvalue 100:   TimeOut4 [ms]
#define u16GetRomConstVoltMinSupply()        (*((u16*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X027E)))       // Defaultvalue 2500:  VoltMinSupply [mV]      Minimal Eingangsspannung. Minimal Spannung, damit der Eingagsbooster aktiviert wird
#define u8GetRomConstCellCount()             (*((u8*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X0280)))        // Defaultvalue 4:     Anzahl Zellen der Lipo
#define rszGetRomConstMagicPattern()         ((rsz)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X0FFC))           // Defaultvalue FLKA   
#define u32GetRomConstChecksum()             (*((u32*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X0FF8)))       // Defaultvalue 489657 
