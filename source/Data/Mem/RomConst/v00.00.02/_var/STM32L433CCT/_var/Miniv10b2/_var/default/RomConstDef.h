...
#define rszGetRomConstDeviceName()           ((rsz)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X0000))           // Defaultvalue MBv9b2LedCntr
...
#define u16GetRomConstHwInfo()               (*((u16*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X004C)))       // Defaultvalue 9      
...
#define u32GetRomConstChecksum1()            (*((u32*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X0178)))       // Defaultvalue 13109  
...
#define u8GetRomConstChrgCellCount()         (*((u8*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X0281)))        // Defaultvalue 1:     Anzahl Zellen der Lipo
...
#define u16GetRomConstChrgCurrentCharged()   (*((u16*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X028E)))       // Defaultvalue 9999:  CurrentCharged [mA]     Laden wird beendet, sobald diese Strom unterschritten ist
#define u16GetRomConstChrgVoltStart()        (*((u16*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X0290)))       // Defaultvalue 3400:  VoltStart [mV]          Spannung, bei der das Laden gestartet wird
...
#define u8GetRomConstModulInType()           (*((u8*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X02C1)))        // Defaultvalue 7:     Type des Input Moduls
...
#define u32GetRomConstChecksum2()            (*((u32*)(ROMCONST_PARTITION_START_ADRESS_EEP + 0X03F8)))       // Defaultvalue 59846  
