...
#define ROMCONST_PARTITION_SIZE_IMG (408 * 1024)
#define ROMCONST_PARTITION_SIZE_EEP (  8 * 1024)
...
#define ROMCONST_PARTITION_START_ADRESS_BLU   (u8*)(ROMCONST_PARTITION_START_ADRESS_BL  + ROMCONST_PARTITION_SIZE_BL)
#define ROMCONST_PARTITION_START_ADRESS_APP   (u8*)(ROMCONST_PARTITION_START_ADRESS_BLU + ROMCONST_PARTITION_SIZE_BLU)
#define ROMCONST_PARTITION_START_ADRESS_IMG   (u8*)(ROMCONST_PARTITION_START_ADRESS_APP + ROMCONST_PARTITION_SIZE_APP)
#define ROMCONST_PARTITION_START_ADRESS_EEP   (u8*)(ROMCONST_PARTITION_START_ADRESS_IMG + ROMCONST_PARTITION_SIZE_IMG)
