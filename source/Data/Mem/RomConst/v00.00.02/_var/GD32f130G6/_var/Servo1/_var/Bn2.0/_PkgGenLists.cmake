...
set (gen_files 
	...
	# List of all source files found in GD32f130G6_gen_files
	./_var/GD32f130G6/RomConst.c
	# List of all source files found in GD32f130G6_Servo1_gen_files
	# List of all source files found in GD32f130G6_Servo1_Bn2.0_gen_files
)
...
set (gen_headers 
	...
	# List of all source files found in GD32f130G6_gen_headers
	./_var/GD32f130G6/RomConst.h
	# List of all source files found in GD32f130G6_Servo1_gen_headers
	# List of all source files found in GD32f130G6_Servo1_Bn2.0_gen_headers
	./_var/GD32f130G6/_var/Servo1/_var/Bn2.0/RomConstDef.h
)
...
set (gen_asmfiles 
	...
	# List of all source files found in GD32f130G6_gen_asmfiles
	# List of all source files found in GD32f130G6_Servo1_gen_asmfiles
	# List of all source files found in GD32f130G6_Servo1_Bn2.0_gen_asmfiles
)
...
set (gen_include_directories 
	...
	# List of all source files found in GD32f130G6_gen_include_directories
	./_var/GD32f130G6
	# List of all source files found in GD32f130G6_Servo1_gen_include_directories
	# List of all source files found in GD32f130G6_Servo1_Bn2.0_gen_include_directories
	./_var/GD32f130G6/_var/Servo1/_var/Bn2.0
)
