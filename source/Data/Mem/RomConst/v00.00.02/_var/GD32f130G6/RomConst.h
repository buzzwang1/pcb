...
#define ROMCONST_PARTITION_SIZE_BL  ( 11 * 1024)
#define ROMCONST_PARTITION_SIZE_APP ( 20 * 1024)
...
#define ROMCONST_PARTITION_START_ADRESS_EEP   (u8*)(ROMCONST_PARTITION_START_ADRESS_FLASH + ROMCONST_PARTITION_SIZE_BL + ROMCONST_PARTITION_SIZE_APP)
