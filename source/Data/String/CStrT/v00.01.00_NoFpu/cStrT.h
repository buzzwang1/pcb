...
*/
  ...
  public:
    ...
    CSTRT_UINT StartOfText(CSTRT_UINT li32StartIdx = 0)
    {
      ...
      for (lpszTemp = (const char8*)&mpu8Data[li32StartIdx]; li32StartIdx < cbArrayExtT<tyCStrT>::muiLen; lpszTemp++)
      {
    ...
    {
      const char8* lpszTemp = (const char8*)&mpu8Data[li32StartIdx];
      if (cStrT_isspace(*lpszTemp) || (*lpszTemp == '-')) return li32StartIdx;
    ...
    CSTRT_INT Atoi(void)
    {
      return cStrT_Atoin((char8*)mpu8Data, muiLen);
    };
    ...
    CSTRT_INT Atoi(CSTRT_INT offset)
    {
      if (offset < muiLen)
      {
        return cStrT_Atoin((char8*)cbArrayT<tyCStrT>::mpu8Data + offset, muiLen - offset);
      }
      else
      {
        return CSTRT_UINTMAX;
