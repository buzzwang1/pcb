...
set(gen_pkg_name "cDepTreeCfg")

# List of all source files found in the packages filetree
set (gen_files 
	# List of all source files found in gen_files
	# List of all source files found in MiniAddon_gen_files
	./_var/MiniAddon/cDepTreeCfg.cpp
)
...
set (gen_headers 
	...
	# List of all source files found in MiniAddon_gen_headers
	./_var/MiniAddon/cDepTreeCfg.h
)
...
set (gen_asmfiles 
	...
	# List of all source files found in MiniAddon_gen_asmfiles
)
...
set (gen_include_directories 
	...
	# List of all source files found in MiniAddon_gen_include_directories
	./_var/MiniAddon
)
