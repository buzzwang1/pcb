...
set(gen_pkg_name "cDepTree")

# List of all source files found in the packages filetree
set (gen_files 
	# List of all source files found in gen_files
	# List of all source files found in Static_gen_files
	./_var/Static/cDepTree.cpp
)
...
set (gen_headers 
	...
	# List of all source files found in Static_gen_headers
	./_var/Static/cDepTree.h
)
...
set (gen_asmfiles 
	...
	# List of all source files found in Static_gen_asmfiles
)
...
set (gen_include_directories 
	...
	# List of all source files found in Static_gen_include_directories
	./_var/Static
)
