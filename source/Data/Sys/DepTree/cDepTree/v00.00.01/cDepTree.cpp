...
//osThreadId_t cDepTree::mTask16msHandle = 0;
//osThreadId_t cDepTree::mTask128msHandle = 0;
//osThreadId_t cDepTree::mTask1024msHandle = 0;
...
const osThreadAttr_t TaskcDepTreeInit1_attributes = {
  ...
  .stack_mem = 0,                          ///< memory for stack
  .stack_size = (1024 * 2),                ///< size of stack
  .priority = (osPriority_t)osPriorityLow1, ///< initial thread priority (default: osPriorityNormal)
  .tz_module = 0,                          ///< TrustZone module identifier
  .reserved = 0                            ///< reserved (must be 0)
};
...
//const osThreadAttr_t TaskcDepTree16ms_attributes = {
//  .name = "cDepTree16ms",                  ///< name of the thread
//  .attr_bits = 0,                          ///< attribute bits
//  .cb_mem = 0,                             ///< memory for control block
//  .cb_size = 0,                            ///< size of provided memory for control block
//  .stack_mem = 0,                          ///< memory for stack
...
//};
//
//const osThreadAttr_t TaskcDepTree128ms_attributes = {
//  .name = "cDepTree128ms",                 ///< name of the thread
//  .attr_bits = 0,                          ///< attribute bits
//  .cb_mem = 0,                             ///< memory for control block
//  .cb_size = 0,                            ///< size of provided memory for control block
//  .stack_mem = 0,                          ///< memory for stack
...
//};
//
//const osThreadAttr_t TaskcDepTree1024ms_attributes = {
//  .name = "cDepTree1024ms",                ///< name of the thread
//  .attr_bits = 0,                          ///< attribute bits
//  .cb_mem = 0,                             ///< memory for control block
//  .cb_size = 0,                            ///< size of provided memory for control block
//  .stack_mem = 0,                          ///< memory for stack
...
//void TaskcDepTree16ms(void* argument)
//{
//  UNUSED(argument);
//  vTaskSuspend(NULL);
//  while (1)
...
//
//
//void TaskcDepTree128ms(void* argument)
//{
//  UNUSED(argument);
//  vTaskSuspend(NULL);
//  while (1)
...
//
//
//void TaskcDepTree1024ms(void* argument)
//{
//  UNUSED(argument);
//  vTaskSuspend(NULL);
//  while (1)
//  {
//    cDepTree::v1024msTask();
//  }
//}
