...
void cI2c::I2C_StartDMA(uint8* pBuffer, uint32 BufferSize, uint32 Direction)
{
  ...
  if (Direction == I2C_DIRECTION_TX)
  {
    if (mI2C == I2C1)
    {
      ...
      DMA_ITConfig(DMA1_Channel6, DMA_IT_TE | DMA_IT_TC, ENABLE);
    ...
    else
    {
      ...
      DMA_ITConfig(DMA1_Channel4, DMA_IT_TE | DMA_IT_TC, ENABLE);
  ...
  else /* Reception */
  {
    if (mI2C == I2C1)
    {
      ...
      DMA_ITConfig(DMA1_Channel7, DMA_IT_TE | DMA_IT_TC, ENABLE);
    ...
    else
    {
      ...
      DMA_ITConfig(DMA1_Channel5, DMA_IT_TE | DMA_IT_TC, ENABLE);
...
void cI2c::vInitHw(bool lbMaster)
{
  ...
  mPinSCL->vSetMode(GPIO_Mode_AF_PP);
  mPinSDA->vSetMode(GPIO_Mode_AF_PP);
