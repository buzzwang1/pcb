...
cINA3221::cINA3221(cComNodeMaster* lpcI2C, uint8 lui8Adr, uint16 lui16Shunt1, uint16 lui16Shunt2, uint16 lui16Shunt3)
...
void cINA3221::vComDone()
{
  ...
  lui16Temp = mpcMsgRead.mpu8Data[1] + (mpcMsgRead.mpu8Data[0] << 8);
  ...
  switch (menCmd)
  {
    ...
    case enCmdInit:
      ...
      mpcMsgWrite.mpu8Data[0] = INA3221_REG_CONFIG;
      mpcMsgWrite.mpu8Data[1] = (uint8)(lRegConf.ui16Value >> 8);
      mpcMsgWrite.mpu8Data[2] = (uint8)lRegConf.ui16Value;
      mpcMsgWrite.muLen = 3;
...
void cINA3221::vStartWriteReg(u16 lu16Idx)
{
  ...
  mpcMsgWrite.mpu8Data[0] = lu16Idx;
  mpcMsgWrite.mpu8Data[1] = (uint8)(lu16Value >> 8);
  mpcMsgWrite.mpu8Data[2] = (uint8)lu16Value;
  mpcMsgWrite.muLen = 3;
  mI2C->vStartMsg(&mpcMsgWrite);
}
...
{
  mpcMsgRead.vPrepareTxRx(1, 2, (u8*)&lu16Idx);
