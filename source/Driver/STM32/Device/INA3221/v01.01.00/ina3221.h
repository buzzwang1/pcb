...
class cINA3221: public cComNode
{
  ...
  cINA3221(cComNodeMaster* lpcI2C, uint8 lui8Adr, uint16 lui16Shunt1, uint16 lui16Shunt2, uint16 lui16Shunt3);
  ...
  void vRestart()
  {
    ...
    mControl.StartRequest = mbInit | mbReadReg | mbWriteReg;
  }
