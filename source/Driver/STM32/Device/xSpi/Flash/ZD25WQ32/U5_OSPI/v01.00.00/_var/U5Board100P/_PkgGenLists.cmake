...
set(gen_pkg_name "ZD25WQ32")

# List of all source files found in the packages filetree
set (gen_files 
	# List of all source files found in gen_files
	./ZD25WQ32.cpp
	# List of all source files found in U5Board100P_gen_files
	./_var/U5Board100P/ZD25WQ32_HW.cpp
)
...
set (gen_headers 
	...
	./ZD25WQ32.h
	# List of all source files found in U5Board100P_gen_headers
	./_var/U5Board100P/ZD25WQ32_HW.h
)
...
set (gen_asmfiles 
	...
	# List of all source files found in U5Board100P_gen_asmfiles
)
...
set (gen_include_directories 
	...
	.
	# List of all source files found in U5Board100P_gen_include_directories
	./_var/U5Board100P
)
