...
set (gen_files 
	...
	./sys/sys.c
	./usart/usart.c
	# List of all source files found in NoOs_gen_files
)
...
set (gen_headers 
	...
	./delay/delay.h
	./usart/usart.h
	# List of all source files found in NoOs_gen_headers
	./_var/NoOs/sys.h
)
...
set (gen_asmfiles 
	...
	# List of all source files found in NoOs_gen_asmfiles
)
...
set (gen_include_directories 
	...
	./delay
	./usart
	# List of all source files found in NoOs_gen_include_directories
	./_var/NoOs
)
