...
#define cAPDS9960_vSetStartRequest()  mControl.StartRequest = (uint8)(mbInit |\
                                                                 mbSetMode |\
                                                                 mbReadAmbientLight |\
                                                                 mbSetControl |\
...
void cAPDS9960::vTick(u16 lu16Time_ms)
{
  if (muRestart_ms)
  {
...
int8 cAPDS9960::i8Setup()
{
  ...
  this->stRegSet.ui8ATIME   = 0xFF; // 2,78ms. The ATIME register controls the internal integration time of ALS/Color analog to digital converters.
  this->stRegSet.ui8WTIME   = 0xFF; // 2,78ms. The  WTIME  controls  the  amount  of  time  in  a  low  power  mode  between  Proximity  and/or  ALS  cycles.
  this->stRegSet.ui8CONFIG1 = 0x60; //
