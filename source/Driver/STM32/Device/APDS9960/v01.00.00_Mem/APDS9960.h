...
#define nAPDS9960_DEFAULT_GOFFSET_U      10        // No offset scaling for gesture mode
#define nAPDS9960_DEFAULT_GOFFSET_D       0        // No offset scaling for gesture mode
#define nAPDS9960_DEFAULT_GOFFSET_L      10        // No offset scaling for gesture mode
#define nAPDS9960_DEFAULT_GOFFSET_R       1        // No offset scaling for gesture mode
...
public:
  ...
  void put(uint8 lu8Zwerg)
  {
    __disable_irq();
    mu8Buf[mu8Head] = lu8Zwerg;
    mu8Head = (mu8Head + 1) & 31;

    if (mu8Head == mu8Tail)
    {
      mu8Tail = (mu8Tail + 1) & 31;
    }
    mu8Cnt++;
    __enable_irq();
  }
...
class cAPDS9960: public cComNode
{
  ...
  cAPDS9960_RingBuf mcU, mcD, mcL, mcR;
