...
class cST7735: public cST7735_HW
{
  public:
  ...
  : cST7735_HW()
  {
    vInit(tenScrOrientation::LANDSCAPE);
  }

  cST7735(tenScrOrientation lenOrientation)
  : cST7735_HW()
  {
    vInit(lenOrientation);
  }

  void vInit(tenScrOrientation lenOrientation)
  {
    // Reset display
    mPinCs.vSet1();
    mPinRst.vSet1();
    ...
    if (isDisplayInversionOn())
    {
      cmd2(0x21);   // Display inversion on
    }
  ...
  void vOrientation(tenScrOrientation orientation)
  {
    static const u8 lu8OrientationTab[4][2] =
    {
    ...
    switch(orientation)
    {
      case tenScrOrientation::PORTRAIT:
        mu16ScrOftX   = i16GetOftX();
        mu16ScrOftY   = i16GetOftY();
        mu16ScrWidth  = i16GetWidth();
        mu16ScrHeight = i16GetHeight();
        break;
      case tenScrOrientation::PORTRAIT_ROT180:
        mu16ScrOftX   = i16GetOftX();
        mu16ScrOftY   = i16GetOftY();
        mu16ScrWidth  = i16GetWidth();
        mu16ScrHeight = i16GetHeight();
        break;
      case tenScrOrientation::LANDSCAPE:
        mu16ScrOftX   = i16GetOftY();
        mu16ScrOftY   = i16GetOftX();
        mu16ScrWidth  = i16GetHeight();
        mu16ScrHeight = i16GetWidth();
        break;
      case tenScrOrientation::LANDSCAPE_ROT180:
        mu16ScrOftX   = i16GetOftY();
        mu16ScrOftY   = i16GetOftX();
        mu16ScrWidth  = i16GetHeight();
        mu16ScrHeight = i16GetWidth();
    ...
    lu8Temp = lu8OrientationTab[(u8)orientation][1] + (u8BGR() << 3);
  ...
  void vClear(u16 color)
  {
    ...
    mPinCs.vSet0();
    vAddrSet(mu16ScrOftX, mu16ScrOftY, mu16ScrWidth + mu16ScrOftX - 1, mu16ScrHeight - 1 + mu16ScrOftY);
    mPinA0.vSet1();
  ...
  void vTest(u16 color)
  {
    ...
    vAddrSet2(mu16ScrOftX, mu16ScrOftY, mu16ScrWidth + mu16ScrOftX - 1, mu16ScrHeight - 1 + mu16ScrOftY);
