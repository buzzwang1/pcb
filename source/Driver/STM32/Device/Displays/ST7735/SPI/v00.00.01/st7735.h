...
class cST7735: public cST7735_HW
{
  ...
  cST7735(ScrOrientation_TypeDef lenOrientation) 
  : cST7735_HW()
  {
  ...
  void vOrientation(ScrOrientation_TypeDef orientation) 
  {
    ...
    {
    case scr_CW:
      mu16ScrWidth  = ST7735_HEIGTH;
      mu16ScrHeight = ST7735_WIDTH;
    ...
    case scr_CCW:
      ...
      break;
    case scr_180:
      mu16ScrWidth  = ST7735_WIDTH;
      mu16ScrHeight = ST7735_HEIGTH;
