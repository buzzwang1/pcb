...
set(gen_pkg_name "st7735")

# List of all source files found in the packages filetree
set (gen_files 
	# List of all source files found in gen_files
	./st7735.cpp
	# List of all source files found in L433CCT_SPI1_DMA_PWRBX_gen_files
	./_var/L433CCT_SPI1_DMA_PWRBX/st7735HW.cpp
)
...
set (gen_headers 
	...
	./st7735.h
	# List of all source files found in L433CCT_SPI1_DMA_PWRBX_gen_headers
	./_var/L433CCT_SPI1_DMA_PWRBX/st7735HW.h
)
...
set (gen_asmfiles 
	...
	# List of all source files found in L433CCT_SPI1_DMA_PWRBX_gen_asmfiles
)
...
set (gen_include_directories 
	...
	.
	# List of all source files found in L433CCT_SPI1_DMA_PWRBX_gen_include_directories
	./_var/L433CCT_SPI1_DMA_PWRBX
)
