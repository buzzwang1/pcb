...
set(gen_pkg_name "ili9488")

# List of all source files found in the packages filetree
set (gen_files 
	# List of all source files found in gen_files
	./ili9488.cpp
	# List of all source files found in U575_SPI1_DMA_gen_files
	./_var/U575_SPI1_DMA/ili9488HW.cpp
)
...
set (gen_headers 
	...
	./ili9488.h
	# List of all source files found in U575_SPI1_DMA_gen_headers
	./_var/U575_SPI1_DMA/ili9488HW.h
)
...
set (gen_asmfiles 
	...
	# List of all source files found in U575_SPI1_DMA_gen_asmfiles
)
...
set (gen_include_directories 
	...
	.
	# List of all source files found in U575_SPI1_DMA_gen_include_directories
	./_var/U575_SPI1_DMA
)
