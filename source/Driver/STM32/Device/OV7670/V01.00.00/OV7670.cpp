...
cBitmap_Bpp16_5R6G5B* OV7670_mpcBm;
uint8                 OV7670_mui8ImgReady;

const uint8 OV7670_reg [OV7670_REG_NUM][2] =
{
  {0x12, 0x80},    //Reset registers

  // Image format
  {0x12, 0x14},    //QVGA 320x240 size, RGB mode
  {0x40, 0xd0},    //RGB565
...
int8 SCCB_write_reg(uint8 reg_addr, uint8* data)
{
...
void DCMI_DMA_init(void){
  ...
  DMA_InitStructure.DMA_Memory0BaseAddr = (uint32_t)OV7670_mpcBm->mpui8Data;
...
void OV7670_DMA_TC(void)
{
  ...
  OV7670_mui8ImgReady = 1;
  DCMI_CaptureCmd(DISABLE);
}

uint8 OV7670_isCaptureReady(void)
{
  return OV7670_mui8ImgReady;
}

void OV7670_StartCapture(void)
{
  OV7670_mui8ImgReady = 0;
  DMA_Cmd(DMA2_Stream1, ENABLE);
