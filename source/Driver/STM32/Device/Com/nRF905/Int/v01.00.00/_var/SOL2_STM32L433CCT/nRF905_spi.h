...
class cNRF905_Pins
{
  ...
  //Outputs
  tcGpPin<GPIOA_BASE, 3> mTRx_Cn; // Chip select
  tcGpPin<GPIOA_BASE, 2>  mTx_En;  // TX or RX (1 = Tx Mode, 0 = Rx Mode)
  tcGpPin<GPIOC_BASE, 13>  mPWR;    // Power
  tcGpPin<GPIOA_BASE, 1>  mCS_SPI; // Chip select SPI

  //Inputs
  tcGpPin<GPIOC_BASE, 14>  mCD;  // Carrier Detected
  tcGpPin<GPIOB_BASE, 3> mAM;  // Adress Match
