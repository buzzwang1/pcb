...
class cNRF905_Pins
{
  ...
  //Outputs
  tcGpPin<GPIOC_BASE, 14> mTRx_Cn; // Chip select
  tcGpPin<GPIOB_BASE, 5>  mTx_En;  // TX or RX (1 = Tx Mode, 0 = Rx Mode)
  tcGpPin<GPIOB_BASE, 4>  mPWR;    // Power
  tcGpPin<GPIOA_BASE, 4>  mCS_SPI; // Chip select SPI
