...
class cNRF905Bn: public cSpi
{
  ...
  typedef struct __attribute__((packed))
  {
    ...
    u8 Hfreq_Pll:1;
    u8 Output_Power:2;
    u8 Rx_Reduced_Power:1;
    u8 Auto_Retransmit:1;
    u8 NotUsed1:2;

    u8  Rx_Transmit_Width:3;
    u8  NotUsed2:1;
    u8  Tx_Transmit_Width:3;
    u8  NotUsed3:1;

    u8  Rx_Payload_Width;//:6;
    //u8  NotUsed4:2;

    u8  Tx_Payload_Width;//:6;
    //u8  NotUsed5:2;

    u32 RxAdress;

    u8  Output_Clock_Frequency : 2;
    u8  Output_Clock_Enabled   : 1;
    u8  Crystal_Osc_Freq       : 3;
  ...
  typedef struct __attribute__((packed))
  {
    ...
    u8               u8SpiCmdTxPl;
    u8               mui8TxPayLoad[NRF905_MAX_PAYLOAD];
    u8               u8SpiCmdTxAdr;
    u32              mui32TxAdress;
    u8               u8SpiCmdRxPl;
    u8               mui8RxPayLoad[NRF905_MAX_PAYLOAD];
    u8               u8SpiCmdTxPlW;
    u8               mui8TxPayLoadWidth;
    u8               u8SpiCmdRxPlW;
    u8               mui8RxPayLoadWidth;
  ...
  cNRF905Bn(SPI_TypeDef* lpstSpi, u8 lu8DmaChTx, u8 lu8DmaChRx)
    : cSpi(lpstSpi, lu8DmaChTx, lu8DmaChRx), mPins(), mTimer()
  {
    ...
    menMode = NRF905_RADIO_MODE_PWR_DOWN;
  ...
  bool bEventHandler(tenCmdEvents lenEvent) // __attribute__((optimize("-O0")))
  {
    do
    {
      if (lenEvent == cNRF905Bn::NRF905_EvLoop)
      {
        lenEvent = cNRF905Bn::NRF905_EvDummy;
      }
      ...
      switch (mSm)
      {
        ...
        case NRF905_StWriteConfig:
          mSm = NRF905_StWriteConfig2;
          {
            ...
            {
              lenEvent = cNRF905Bn::NRF905_EvLoop;
            }
          }
          break;
        ...
        case NRF905_StWriteConfig2:
          ...
          mPins.mCS_SPI.vSet0();
          vStartDMATx((u8*)&mstNRF905.u8SpiCmdCfg, sizeof(tstNRF905_Config) + 1); // + 1 Wegen Indexbyte am Anfang
          break;
        ...
        case NRF905_StWriteConfig4:
          ...
          mPins.mCS_SPI.vSet0();
          vStartDMATx((u8*)&mstNRF905.u8SpiCmdTxAdr, 4 + 1); // + 1 Wegen Indexbyte am Anfang
          break;
        ...
        case NRF905_StTransmit2: // TX Payload Cnt Setzen Daten
          ...
          if (mstNRF905.mui8TxPayLoadWidth != mstNRF905.mstConfig.Tx_Payload_Width)
          {
            ...
            vStartDMATx((u8*)&mstNRF905.u8SpiCmdTxPlW, 2);
          }
          else
          {
            lenEvent = cNRF905Bn::NRF905_EvLoop;
        ...
        case NRF905_StReceive4: // RX Payload Cnt Setzen Daten
          ...
          if (mstNRF905.mui8RxPayLoadWidth != mstNRF905.mstConfig.Rx_Payload_Width)
          {
            ...
            vStartDMATx((u8*)&mstNRF905.u8SpiCmdRxPlW, 2);
          }
          else
          {
    ...
    } while (lenEvent == cNRF905Bn::NRF905_EvLoop);
    ...
    if (menMode != lenNewMode)
    {
      switch (lenNewMode)
      {
        ...
        case NRF905_RADIO_MODE_TX_PULSE:
          mPins.mTRx_Cn.vSet1();
          lu16Ret = 10; //  NRF905_WAIT_TX_MODE_WAIT;
          break;
        default:
          break;
      }
  ...
  void vSetRxAdressWidth(u8 lu8Width)
  {
    mstNRF905.mstConfig.Rx_Transmit_Width = lu8Width;
  }

  void vSetTxAdressWidth(u8 lu8Width)
  {
    mstNRF905.mstConfig.Tx_Transmit_Width = lu8Width;
  }

  void vSetRxAdress(u32 lu32Adress)
  {
    mstNRF905.mstConfig.RxAdress = mstNRF905.mui32TxAdress = lu32Adress;
  }

  void vSetTxAdress(u32 lu32Adress)
  {
    mstNRF905.mui32TxAdress = lu32Adress;

  }

  void vSetTxPayloadWidth(u8 lu8PlWidth)
  {
    mstNRF905.mstConfig.Tx_Payload_Width = lu8PlWidth;
  }

  void vSetRxPayloadWidth(u8 lu8PlWidth)
  {
    mstNRF905.mstConfig.Rx_Payload_Width = lu8PlWidth;
  }
  ...
  void vRead_Config()
  {
    mPins.mCS_SPI.vSet0();
    {
      u8 lui8Cmd = NRF905_CMD_R_CONFIG;
      cSpi::vWrite(&lui8Cmd, 1);
      cSpi::vRead((u8*)&mstNRF905.mstConfig, NRF905_CFG_REG_SIZE);
    }
    mPins.mCS_SPI.vSet1();
  }
  void vWrite_Config()
  {
    mPins.mCS_SPI.vSet0();
    {
      u8 lui8Cmd = NRF905_CMD_W_CONFIG;
      cSpi::vWrite(&lui8Cmd, 1);
      cSpi::vWrite((u8*)&mstNRF905.mstConfig, NRF905_CFG_REG_SIZE);
    }
    mPins.mCS_SPI.vSet1();
  }
  ...
  void vRead_TxAdress()
  {
    mPins.mCS_SPI.vSet0();
    {
      u8 lui8Cmd = NRF905_CMD_R_TX_ADDRESS;
      cSpi::vWrite(&lui8Cmd, 1);
      cSpi::vRead((u8*)&mstNRF905.mui32TxAdress, 4);
    }
    mPins.mCS_SPI.vSet1();
  }
  ...
  void vWrite_TxAdress()
  {
    mPins.mCS_SPI.vSet0();
    {
      u8 lui8Cmd = NRF905_CMD_W_TX_ADDRESS;
      cSpi::vWrite(&lui8Cmd, 1);
      cSpi::vWrite((u8*)&mstNRF905.mui32TxAdress, 4);
    }
    mPins.mCS_SPI.vSet1();
  }
};
...
class cNRF905BnMaster : public cNRF905Bn, public cComNodeMasterSingle
{
  public:
  u8 mu8SelfTimer;
  u8 mu8MsgIdx;
  ...
  cNRF905BnMaster(SPI_TypeDef* lpstSpi, u8 lu8DmaChTx, u8 lu8DmaChRx,
                  u16 lu32Prescaler = 256, u16 luInitDelay_ms = 1)
    : cNRF905Bn(lpstSpi, lu8DmaChTx, lu8DmaChRx),
  ...
  {
    cNRF905Bn::mPins.vInit();
    cNRF905Bn::mTimer.vInit();
    cNRF905Bn::enInitHw(True);
    u32 lu32TxAdress = 0x12345678;
    ...
    do
    {
      mstNRF905.mui32TxAdress = lu32TxAdress;
      vWrite_TxAdress();
      mstNRF905.mui32TxAdress = 0xFFFFFFFF;
      vRead_TxAdress();
    } while ((mstNRF905.mui32TxAdress != lu32TxAdress) && (!mTimer.isDone()));

    mTimer.vStop();
    mTimer.vEnableIrq();

    //Check if write => read is working
    if (mstNRF905.mui32TxAdress == lu32TxAdress)
    {
      //vWrite_Config();
      //vRead_Config();
      //vRead_Status();
  ...
  void vPowerDown()
  {
    cNRF905Bn::u16Start_Set_Mode(cNRF905Bn::NRF905_RADIO_MODE_PWR_DOWN);
  }
  ...
  {
    if (cNRF905Bn::mSm != cNRF905Bn::NRF905_StIdle)
    {
      switch (lenEvent)
      {
        case cComNode::tenEvent::enEvSpiTc:
          if (cNRF905Bn::bEventHandler(cNRF905Bn::NRF905_EvSpiTc))
          {
        ...
        case cComNode::tenEvent::enEvUsartTimer:
          if (cNRF905Bn::bEventHandler(cNRF905Bn::NRF905_EvTimer))
          {
            vSm(cComNode::tenEvent::enEvDone);
          }
          return;
        ...
        case cComNode::tenEvent::enEvUsartExtiP1:
          if (cNRF905Bn::bEventHandler(cNRF905Bn::NRF905_EvDataReady))
          {
            vSm(cComNode::tenEvent::enEvDone);
          }
          return;
  ...
  {
    cNRF905Bn::mTimer.vStart(luTime_us);
  };
                ...
                case cComNode::tenDirection::enIsTx:
                  {
                    ...
                    cNRF905Bn::mstNRF905.mstConfig.Tx_Payload_Width = u8Len;
                    cMemTools::vMemCpy(cNRF905Bn::mstNRF905.mui8TxPayLoad, mpcActiveMsg->Data(), u8Len);
                    cNRF905Bn::vStartTransmit();
                  }
                  break;
                case cComNode::tenDirection::enIsRx:
                  {
                    ...
                    cNRF905Bn::mstNRF905.mstConfig.Rx_Payload_Width = u8Len;
                    cNRF905Bn::vStartReceive();
                    mu8Timeout_ms = 25;
                  }
                  break;
                case cComNode::tenDirection::enCfgWrite:
                  cComNodeMasterSingle::mSm = cComNode::tenState::enStEnd;
                  cNRF905Bn::bStartUpdateCfg();
                  break;
                default:
                  vDone();
                  break;
    ...
    case cComNode::tenState::enStEndRx:
      {
        if (lenEvent == cComNode::tenEvent::enEvDone)
        {
          ...
          cMemTools::vMemCpy(mpcActiveMsg->Data() + mu8MsgIdx, cNRF905Bn::mstNRF905.mui8RxPayLoad, u8Len);
          mu8MsgIdx += 32;
    ...
    case cComNode::tenState::enStTx: // Conseutive Msg
      {
        ...
        cComNodeMasterSingle::mSm = cComNode::tenState::enStEndTx;
        cNRF905Bn::mstNRF905.mstConfig.Tx_Payload_Width = u8Len;
        cMemTools::vMemCpy(cNRF905Bn::mstNRF905.mui8TxPayLoad, mpcActiveMsg->Data() + mu8MsgIdx, u8Len);
        cNRF905Bn::vStartTransmit();
      }
      break;
    ...
    case cComNode::tenState::enStEndTx:
      {
        if (lenEvent == cComNode::tenEvent::enEvDone)
        {
          ...
          else
          {
            ...
            mTimer.vStart(cNRF905Bn::NRF905_WAIT_TX_DELAY);
          }
        }
      }
      break;
...
class cNRF905BnSlave : public cNRF905Bn, public cComNodeSlave
{
  public:
  u8 mu8SelfTimer;
  u8 mu8MsgIdx;
