...
void cMP8859::vComStart(cComNode::tenEvent lenEvent)
{
  ...
  if (menCmd == enCmdIdle)
  {
    ...
    mControl.StartRequest = mbInit | mbCmdSetCurrent | mbCmdSetVoltage | mbCmdSetCtrl1;
  }
}
...
void cMP8859::vComDone()
{
  ...
  switch (menCmd)
  {
    ...
    case enCmdInit2:
      u8 lui8Temp;
      lui8Temp = mpcMsgRead.mpu8Data[0];
...
void cMP8859::vStartWriteReg(u8 lu8Idx)
{
  ...
  mpcMsgWrite.mpu8Data[0] = lu8Idx;
  mpcMsgWrite.mpu8Data[1] = lu8Value;
  mpcMsgWrite.muLen = 2;
...
{
  mpcMsgRead.vPrepareTxRx(1, 2, (u8*)&lu8Idx);
