...
set(PkgCfg_ListLinkLibraries core_lib ${CMAKE_CURRENT_LIST_DIR}/libhal_lib_o3.a)
...
set(PkgCfg_TargetCompileOption -O3)
...
if(NOT EXISTS "${CMAKE_CURRENT_LIST_DIR}/libhal_lib_${PkgCfg_LibOptiLevel}.a")
  ...
  execute_process(
      COMMAND build.bat STM/L4/HalLib/v01.15.01.${PkgCfg_LibOptiLevel} first
      WORKING_DIRECTORY ${PCB_ProjCfg_system_dir_root})
      
  file(COPY ${PCB_ProjCfg_system_dir_build}/STM/L4/HalLib/v01.15.01/${PkgCfg_LibOptiLevel}/cmake/lib/libhal_lib.a
        DESTINATION ${CMAKE_CURRENT_LIST_DIR})
	
  file(RENAME ${CMAKE_CURRENT_LIST_DIR}/libhal_lib.a ${CMAKE_CURRENT_LIST_DIR}/libhal_lib_${PkgCfg_LibOptiLevel}.a)
  
  file(REMOVE_RECURSE ${PCB_ProjCfg_system_dir_build}/STM/L4/HalLib/v01.15.01/${PkgCfg_LibOptiLevel})
endif()
