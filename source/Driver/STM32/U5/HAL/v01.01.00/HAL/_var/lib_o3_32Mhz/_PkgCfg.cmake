...
if(NOT EXISTS "${CMAKE_CURRENT_LIST_DIR}/libhal_lib_${PkgCfg_LibOptiLevel}.a")
  ...
  execute_process(
      COMMAND build.bat STM/U5/HalLib/v01.01.00.${PkgCfg_LibOptiLevel} first
      WORKING_DIRECTORY ${PCB_ProjCfg_system_dir_root})
      
  file(COPY ${PCB_ProjCfg_system_dir_build}/STM/U5/HalLib/v01.01.00/${PkgCfg_LibOptiLevel}/cmake/lib/libhal_lib.a
        DESTINATION ${CMAKE_CURRENT_LIST_DIR})
	
  file(RENAME ${CMAKE_CURRENT_LIST_DIR}/libhal_lib.a ${CMAKE_CURRENT_LIST_DIR}/libhal_lib_${PkgCfg_LibOptiLevel}.a)
  
  file(REMOVE_RECURSE ${PCB_ProjCfg_system_dir_build}/STM/U5/HalLib/v01.01.00/${PkgCfg_LibOptiLevel})
endif()
