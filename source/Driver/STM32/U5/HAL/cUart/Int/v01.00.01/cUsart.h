...
public:
  ...
  {
    // check if the USART transmission empty interrupt flag was set
        ...
        (LL_USART_IsEnabledIT_TXE((USART_TypeDef*)Port())))
    {
      ...
      ((USART_TypeDef*)Port())->ICR = LL_USART_ISR_TXE_TXFNF;
    ...
    // check if the USART transmission complete interrupt flag was set
