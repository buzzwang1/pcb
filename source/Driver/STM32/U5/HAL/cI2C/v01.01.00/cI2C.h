...
class cI2c
{
  ...
  cI2c(I2C_TypeDef *lstI2c, cGpPin *lcScl, cGpPin *lcSda, u8 lu8DmaCh)
  {
    mI2C = lstI2c;
  ...
  cComNode::tenError enInitHw(bool lbMaster) // __attribute__((optimize("-O0")))
  {
    ...
    if (mI2C == I2C3) mnNVIC_IRQChannelEv = I2C3_EV_IRQn;
	  if (mI2C == I2C4) mnNVIC_IRQChannelEv = I2C4_EV_IRQn;
    ...
    if (mI2C == I2C4) mnNVIC_IRQChannelEr = I2C4_ER_IRQn;
    /* Set the TIMx priority */
...
class cI2cMaster : public cI2c, public cComNodeMasterMulti
{
  ...
  cI2cMaster(I2C_TypeDef *lstI2c, cGpPin *lcScl, cGpPin *lcSda, u8 lu8DmaCh,
             u32 lu32Baud = 400000, u16 luInitDelay_ms = 1)
    : cI2c(lstI2c, lcScl, lcSda, lu8DmaCh),
...
class cI2cSlave : public cI2c, public cComNodeSlave
{
  ...
  cI2cSlave(I2C_TypeDef *lstI2c, cGpPin *lcScl, cGpPin *lcSda, u8 lu8DmaCh,  uint8 lui8Adr1, uint8 lui8Adr2, u32 lu32Baud = 400000, u16 luInitDelay_ms = 1)
  : cI2c(lstI2c, lcScl, lcSda, lu8DmaCh),
