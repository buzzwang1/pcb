...
public:
  ...
  void vSetCnf(const cGpCfg::tenCnf Cnf)
  {
    cGpCfg::vSetCnf(this->Port(), mui16Pin, Cnf);
  }

  void vSetMode(const cGpCfg::tenMode Mode)
  {
    cGpCfg::vSetMode(this->Port(), mui16Pin, Mode);
  }
...
public:
  ...
  void vSetCnf(const cGpCfg::tenCnf Cnf)
  {
    cGpCfg::vSetCnf((GPIO_TypeDef*)mu32PortBase, mui16Pin, Cnf);
  }

  void vSetMode(const cGpCfg::tenMode Mode)
  {
    cGpCfg::vSetMode((GPIO_TypeDef*)mu32PortBase, mui16Pin, Mode);
  }
