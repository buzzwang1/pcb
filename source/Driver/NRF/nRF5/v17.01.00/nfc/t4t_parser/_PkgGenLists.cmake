...
set(gen_pkg_name "nfc_t4t_parser")

# List of all source files found in the packages filetree
set (gen_files 
	# List of all source files found in gen_files
	./apdu/nfc_t4t_apdu.c
	./cc_file/nfc_t4t_cc_file.c
	./hl_detection_procedure/nfc_t4t_hl_detection_procedures.c
	./tlv/nfc_t4t_tlv_block.c
)
...
set (gen_headers 
	...
	./apdu/nfc_t4t_apdu.h
	./cc_file/nfc_t4t_cc_file.h
	./hl_detection_procedure/nfc_t4t_hl_detection_procedures.h
	./tlv/nfc_t4t_tlv_block.h
)
