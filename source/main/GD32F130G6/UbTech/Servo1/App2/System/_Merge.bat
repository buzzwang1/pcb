...
call build.bat *STM/F1/GD32F1x0/UbTech/Servo1/App2* first
call elf2bin.bat *STM/F1/GD32F1x0/UbTech/Servo1/App2* first


cd %mypath%

copy ..\..\..\..\..\..\..\bin\STM\F1\GD32F1x0\UbTech\Servo1\App2\Release\bin\GD32F1x0_UbTech_Servo1_App2.elf.bin App.bin
