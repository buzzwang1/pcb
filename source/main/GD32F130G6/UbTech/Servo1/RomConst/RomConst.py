...
def GenerateRomConst(liBaseAdr, liAdr):
    ...
    SetHeader("Servo1", "GD32L130G6", "Cortex-M3,Rom 32KB,Ram 4KB",  0, liAdr, 5, 256, llstListElements)

    SetPartition(0, "Flash Bl",   16, 0, 0x08000000,                       10*1024, 0x0400, llstListElements)
    SetPartition(1, "Flash APP",  16, 0, 0x08000000 +  10 * 1024,          21*1024, 0x0400, llstListElements)
    SetPartition(2, "Flash IAP",  16, 0, 0x08000000 +  10 * 1024,          21*1024, 0x0400, llstListElements)
    SetPartition(3, "Flash EEP",  16, 0, 0x08000000 +  (10 + 21) * 1024,    1*1024, 0x0400, llstListElements)

    SetPartition(4, "Ram",         0, 0, 0x20000000,                        4*1024,      1, llstListElements)
