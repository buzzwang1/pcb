...
const uint8 mu8RomConstInit[] __attribute__((aligned(4))) = {   };
  ...
  if ((lu16MemorySort == IAP_MM_RAM) || (lu16MemorySort == IAP_MM_FLASH))
  {
    ...
    if (st == TINF_DONE)
    {
          ...
          (!((lu8ForceRam) || (lu8ForceFlash))))
      {
        ...
        memcpy(buf, (u8*)((u32)lpu8HeaderAdr & ((u32)(~(BUFLEN - 1)))), BUFLEN);
        buf[((u32)lpu8HeaderAdr & (BUFLEN - 1)) + 0] = 0x78;
        buf[((u32)lpu8HeaderAdr & (BUFLEN - 1)) + 1] = 0x56;
        buf[((u32)lpu8HeaderAdr & (BUFLEN - 1)) + 2] = 0x34;
        buf[((u32)lpu8HeaderAdr & (BUFLEN - 1)) + 3] = 0x12;
        InAppProg_Platform_vFlash_EreasePage((u8*)((u32)lpu8HeaderAdr & ((u32)(~(BUFLEN - 1)))));
        InAppProg_Platform_vFlash_Program((u8*)((u32)lpu8HeaderAdr & ((u32)(~(BUFLEN - 1)))), buf, BUFLEN);
...
int main(void)
{
  ...
  tstBuRamDef*     lstBuRamDef = (tstBuRamDef*)(&(TAMP->BKP0R));
  u8 lbStartBlu = 0;
