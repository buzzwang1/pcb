...
u32   mu32SpopCounter;
// I2C
cGpPin     mcI2c4_SCL_BnUl(GPIOB_BASE, 13, GPIO_MODE_AF_OD, GPIO_NOPULL, GPIO_SPEED_FREQ_VERY_HIGH, 0);
cGpPin     mcI2c4_SDA_BnUl(GPIOB_BASE, 14, GPIO_MODE_AF_OD, GPIO_NOPULL, GPIO_SPEED_FREQ_VERY_HIGH, 0);
cI2cSlave  mcI2C4_BnSlave(I2C4, &mcI2c4_SCL_BnUl, &mcI2c4_SDA_BnUl, 2, 0, 0, u16GetRomConstBaudUpLink() * 1000);
...
// I2C1: UpLink
cBotNet_UpLinkI2c     mcUpLink(&mcI2C4_BnSlave);
...
void I2C4_EV_IRQHandler(void)
{
  ...
  mcI2C4_BnSlave.I2C_EV_IRQHandler();
}

void I2C4_ER_IRQHandler(void)
{
  mcI2C4_BnSlave.I2C_ER_IRQHandler();
}
