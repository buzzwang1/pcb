...
extern "C" {
  ...
  extern const osThreadAttr_t TaskAppGfx_attributes;
...
class cCompGfx : public cComponent
{
  ...
  static osThreadId_t mTaskAppGfxHandle;
  ...
  bool bRun() override
  {
    ...
    if (mcILI9341.isSeqDone(cIli9341_RegisterMap::nSEQ08WriteGRAMData))
    {
      ...
      osThreadResume(mTaskAppGfxHandle);
    }
  ...
  void vGfxStart()
  {
    mTaskAppGfxHandle = osThreadNew(vTaskAppGfx, (void*)null, &TaskAppGfx_attributes);
  }

  void vGfxTerminate()
  {
    osThreadTerminate(mTaskAppGfxHandle);
  }
  ...
  static void vGfxTask()
  {
    ...
    cBitmap_Bpp16_5R6G5B                     mc16GBm(lcILI9341->mu16Height, lcILI9341->mu16Width, lcILI9341->mau8GRAM);
      ...
      public:
        ...
        cUiElement_MyWindow(cMsgBox *lcMsgBox, cScreen *lpcScreen,
          ...
          : cUiElement_Window(lcMsgBox, lpcScreen, lui32MaxCharacterCount, lpcRFont),
            ...
            mcText(lcMsgBox,   lpcScreen, 256, lpcRFont)
        {
          miSelectionIdx = 0;
        }
...
osThreadId_t cCompGfx::mTaskAppGfxHandle = 0;

const osThreadAttr_t TaskAppGfx_attributes = {
  ...
  .stack_size = (1024 * 8),                ///< size of stack
