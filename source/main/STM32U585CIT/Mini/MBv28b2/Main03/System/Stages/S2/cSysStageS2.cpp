...
cSysStageReq cStage2::mcReq;
cBoard1 cStage2::mcBoard1;
...
cBoard1::tenLogicPower cBoard1::menLogicPower = cBoard1::tenLogicPower::nP1;
cDigiPower    cBoard1::mcDigiPower;
...
void cBoard1::vDeInit()
{
  if (menLogicPower != nP1)
  {
    mcDigiPower.mMX22917_S1.vSet0();
    mcDigiPower.mMX22917_S2.vSet0();
  }
