...
void TaskApp(void* argument)
{
  UNUSED(argument);

  // Init
  cStage8::vDoInitApp();
  cStage8::mbInitAppFinished = True;
  cStage8::mbRunApp = True;

  // Run
  while (cStage8::mbRunApp)
  {
    cStage8::vDoRunApp();
  }

  cStage8::vDoDeInitApp();
  cStage8::mbDeInitAppFinished = True;

  for (;;)
  {
    osThreadSuspend(cStage8::mTaskAppHandle);
  }
}
