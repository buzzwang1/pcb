...
void TaskMem(void* argument)
{
  ...
  // Init
  cStage4::vDoInitMem();
  cStage4::mbInitMemFinished = True;
  cStage4::mbRunMem = True;

  // Run
  while (cStage4::mbRunMem)
  {
    cStage4::vDoRunMem();
  }

  cStage4::vDoDeInitMem();
  cStage4::mbDeInitMemFinished = True;

  for (;;)
  {
    osThreadSuspend(cStage4::mTaskMemHandle);
  }
}
