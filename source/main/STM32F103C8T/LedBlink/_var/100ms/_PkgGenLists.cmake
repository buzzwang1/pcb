...
set (gen_files 
	...
	./main.cpp
	./syscalls.c
	# List of all source files found in 100ms_gen_files
	./_var/100ms/main2.cpp
)
...
set (gen_headers 
	...
	./Test/main1.h
	# List of all source files found in 100ms_gen_headers
	./_var/100ms/main.h
	./_var/100ms/main2.h
)
...
set (gen_asmfiles 
	...
	# List of all source files found in 100ms_gen_asmfiles
)
...
set (gen_include_directories 
	...
	./Test
	# List of all source files found in 100ms_gen_include_directories
	./_var/100ms
)
