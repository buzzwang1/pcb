...
call build.bat *STM/L4/STM32L433CCT/Mini/MBv10b2/Lampe/Flur/01.Release_App* first
call elf2bin.bat *STM/L4/STM32L433CCT/Mini/MBv10b2/Lampe/Flur/01.Release_App* first
...
::APP
copy %pcbroot%\bin\STM\L4\STM32L433CCT\Mini\MBv10b2\Lampe\Flur\01\Release_App\bin\STM32L433CCT_Mini_MBv10b2_Flur_01.elf.bin in\0x08008000_APP.bin
