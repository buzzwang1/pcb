...
::APP
copy %pcbroot%\bin\STM\L4\STM32L433CCT\Mini\MBv10b2\Lampe\Pflanzen\01\Release_App\bin\STM32L433CCT_Mini_MBv10b2_Pflanzen_01.elf.bin in\0x0802C000_APP.bin
