...
void vDoLedBoard()
{
  ...
  // Das System soll wach bleiben wenn,
  //  - die Urzeit zwischen 8 und 20 uhr ist
  bool lbNoSleep = False;
      ...
      switch (menSmLedBoard)
      {
        case enStart:
          if (lbNoSleep)
          {
            ...
            mcSys.mcSMan.mcPowerManager.vStart(100); //  10ms * 100 = 1000s
            menSmLedBoard = enLedBoardPowerOn;
            lbLoop = True;
          }
          break;
        case enLedBoardPowerOn:
          if (lbNoSleep)
          {
            // Das System wach halten
            mcSys.mcSMan.mcPowerManager.vStart(100); //  10ms * 100 = 1000s
            ...
            menSmLedBoard = enLedBoardWaitCom;
            mu8SmLedBoardRetrys = 20;
          }
          break;
        case enLedBoardWaitCom:
          if (lbNoSleep)
          {
            // Das System wach halten
            mcSys.mcSMan.mcPowerManager.vStart(100); //  10ms * 100 = 1000s
            ...
            {
              menSmLedBoard = enLedBoardWaitFailed;
              lbLoop = True;
            }

            if (mcSys.mcCom.mcBn.mcDownLinks[1]->mStatus.IsOnline == 1)
            {
              menSmLedBoard = enLedBoardIsOnline;
              mu8SmLedBoardRetrys = 3; // Sende es 3x
              lbLoop = True;
            }
          }
          break;
        case enLedBoardIsOnline:
          if (lbNoSleep)
          {
            // Das System wach halten
            mcSys.mcSMan.mcPowerManager.vStart(100); //  10ms * 100 = 1000s
            ...
            {
              menSmLedBoard = enLedBoardWaitHighPowerOn;
              mu8SmLedBoardRetrys = 5; // 0.5s warten für Netzteil
              lbLoop = True;
            }
          }
          break;
        case enLedBoardWaitHighPowerOn:
          if (lbNoSleep)
          {
            // Das System wach halten
            mcSys.mcSMan.mcPowerManager.vStart(100); //  10ms * 100 = 1000s
            ...
            {
              menSmLedBoard = enLedBoardHighPowerOn;
              mu8SmLedBoardRetrys = 0;
              lbLoop = True;
            }
          }
          break;
        case enLedBoardHighPowerOn:
          if (lbNoSleep)
          {
            if (mu8SmLedBoardRetrys == 0) // sende es alle 10s
            {
              // Das System wach halten
              mcSys.mcSMan.mcPowerManager.vStart(100); //  10ms * 100 = 1000s
          ...
          {
            menSmLedBoard = enLedBoardHighPowerOnLedOff;
            mu8SmLedBoardRetrys = 0;
            lbLoop = True;
          }
          break;
        case enLedBoardHighPowerOnLedOff:
          if (mu8SmLedBoardRetrys < 3) // sende es alle 10s
          {
            // Das System wach halten
            mcSys.mcSMan.mcPowerManager.vStart(100); //  10ms * 100 = 1000s
            // Das System wach halten
