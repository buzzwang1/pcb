...
def GenerateRomConst(liBaseAdr, liBnAdr):
    ...
    lAdr = SetHeader(lAdr, "MBv10b2Bad",    "STM32L433CCT6", "Cortex-M4,Rom 256KB,Ram 64KB", 0x22,    liBnAdr, 4*1024,   1,       7,        8,    10,       2,        llstListElements)
    ...
    lAdr = Setu16_ArmCm4(lAdr,              9999, "ChrgCurrentCharged",     "CurrentCharged [mA]     Laden wird beendet, sobald diese Strom unterschritten ist",                                                          llstListElements);
    lAdr = Setu16_ArmCm4(lAdr,        BMin + 400, "ChrgVoltStart",          "VoltStart [mV]          Spannung, bei der das Laden gestartet wird",                                                                         llstListElements);
    ...
    lAdr = Setu8_ArmCm4(lAdr,       7, "ModulInType",        "Type des Input Moduls",                                                                                                                      llstListElements);
