...
def GenerateRomConst(liBaseAdr, liBnAdr):
    ...
    lAdr = SetHeader(lAdr, "MBv10b2Servo", "STM32L433CCT6", "Cortex-M4,Rom 256KB,Ram 64KB", 0x22,    liBnAdr, 4*1024,   1,       7,        8,    10,       2,        llstListElements)
    ...
    lAdr = Setu16_ArmCm4(lAdr,   7500, "ModulInSetVoltOutput","Soll Output Spannung des Input Moduls [mV]",                                                                                                llstListElements);
