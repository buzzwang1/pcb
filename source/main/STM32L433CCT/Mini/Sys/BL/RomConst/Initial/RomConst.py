...
def GenerateRomConst(liBaseAdr, liAdr):
    ...
    lAdr = SetHeader(lAdr, "MBv10b2Ini", "STM32L433CCT6", "Cortex-M4,Rom 256KB,Ram 64KB",  2,     0x1000, 4*1024,   1,       2,        8,    10,       2,        llstListElements)
    ...
    lAdr = SetPartition(lAdr,   0,      "Ram",         0,        0,    0x20000000,                            64*1024,            1, llstListElements)
    lAdr = SetPartition(lAdr,   1, "RomConst",        16,        0,    0x08000000 +  (32 + 144 + 76) * 1024,   4*1024,       0x0800, llstListElements)	
    lAdr = SetPartition(lAdr,   2,      "Dmy",         0,        0,    0x00000000,                                  0,            0, llstListElements)
    lAdr = SetPartition(lAdr,   3,      "Dmy",         0,        0,    0x00000000,                                  0,            0, llstListElements)
    lAdr = SetPartition(lAdr,   4,      "Dmy",         0,        0,    0x00000000,                                  0,            0, llstListElements)
    lAdr = SetPartition(lAdr,   5,      "Dmy",         0,        0,    0x00000000,                                  0,            0, llstListElements)
    lAdr = SetPartition(lAdr,   6,      "Dmy",         0,        0,    0x00000000,                                  0,            0, llstListElements)
    lAdr = SetPartition(lAdr,   7,      "Dmy",         0,        0,    0x00000000,                                  0,            0, llstListElements)	
