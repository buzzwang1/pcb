    ...
    if (lcCli->isSpace(100))
    {
      switch (mu16Calls)
      {
        case 0:
          ...
          lszStr.Setf((rsz)"  Illu:    %d[%%]", (u32)(mcWs2812.mfBrigthness)); lcCli->bPrintLn(lszStr);
...
void MAIN_vTick10msLp()
{
  ...
  lu8Brightness = 0;
  if (mcSys.mcBoard.mcBoardCntrl.lenSmS[cBoardCtrl::enS_Ch220V] == mcSys.mcBoard.mcBoardCntrl.enSmStOn)
  {
