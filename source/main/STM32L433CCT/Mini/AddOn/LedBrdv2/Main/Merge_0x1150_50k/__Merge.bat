...
call build.bat *STM/L4/STM32L433CCT/Mini/AddOn/LedBrdv2/Main.Release_App* first
call elf2bin.bat *STM/L4/STM32L433CCT/Mini/AddOn/LedBrdv2/Main.Release_App* first
...
::APP
copy %pcbroot%\bin\STM\L4\STM32L433CCT\Mini\AddOn\LedBrdv2\Main\Release_App\bin\STM32L433CCT_Mini_AddOn_LedBrdv2_Main.elf.bin in\0x08008000_APP.bin

::RomConst
copy ..\RomConst_50k\RomConst_0X0803F000_0X1150.bin in\0x0803F000_RomConst.bin
