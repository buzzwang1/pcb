...
def GenerateRomConst(liBaseAdr, liBnAdr):
    ...
    lAdr = SetHeader(lAdr, "MiniLedBrd", "STM32L433CCT6", "Cortex-M4,Rom 256KB,Ram 64KB", 0x41,    liBnAdr, 4*1024,   1,       6,        8,     3,       2,        llstListElements)
    ...
    #                              3min                    02h00                 2 days                     15s                          50ms                       50khz           50khz           50khz              50khz
    lAdr = SetConfig(lAdr,         3*60,                     2,                    2,                       15,                           50,                       50,             50,             50,                50,        llstListElements)
