...
call build.bat   *STM\L4\STM32L433CCT\Mini\AddOn\PSwitch\v3\I2c.Release_App* first
call elf2bin.bat *STM\L4\STM32L433CCT\Mini\AddOn\PSwitch\v3\I2c.Release_App* first
...
::APP
copy %pcbroot%\bin\STM\L4\STM32L433CCT\Mini\AddOn\PSwitch\v3\I2c\Release_App\bin\STM32L433CCT_Mini_AddOn_PSwitch_v3_I2c.elf.bin in\0x08008000_APP.bin

::RomConst
cd ..\RomConst\MP8859_50k400k
call Make.Bat
cd %mypath%
copy ..\RomConst\MP8859_50k400k\RomConst_0X0803F000_0X1100.bin in\0x0803F000_RomConst.bin
