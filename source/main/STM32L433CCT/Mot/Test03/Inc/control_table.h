...
#define REG_MAX_PWM_100_VALUE        100    // 0..99
...
#define REG_MAX_POSITION_ADC_VALUE      (3200)     // 0..4095
...
// MG92b
#define REG_PID_POSITION_KP_VALUE      30  // k 2000 (modes : 1,2)
#define REG_PID_POSITION_KI_VALUE      8    // k 0..40 (modes : 1,2)
#define REG_PID_POSITION_KD_VALUE      1000  // k 3600 (modes : 1,2)
...
class cControlTable
{
  ...
  void reset_ram_regs()
  {
    ...
    regs[REG_LED] = 0;        // OFF
    regs[REG_CONTROL_MODE] = 0;    // POSITION CONTROL
