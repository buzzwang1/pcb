...
LED<GPIOA_BASE, 2>    mcPA02;
LED<GPIOA_BASE, 9>    mcPA09;
...
cGpPin      mcI2c2_SCL_Bn(GPIOB_BASE, 10, GPIO_Mode_AF_OD, GPIO_Speed_50MHz, 1);
cGpPin      mcI2c2_SDA_Bn(GPIOB_BASE, 11, GPIO_Mode_AF_OD, GPIO_Speed_50MHz, 1);
cI2cSlave   mcI2C2_Bn(I2C2, &mcI2c2_SCL_Bn, &mcI2c2_SDA_Bn, 0, 0);
cBotNet_UpLinkI2c mcUpLink(&mcI2C2_Bn);
...
void DMA1_Channel4_IRQHandler(void)
{
  ...
  //mcI2C2_Bn.I2C_EV_DMAHandler(cComNode::tenEvent::enEvDmaTxTc);
}
...
void DMA1_Channel5_IRQHandler(void)
{
  ...
  //mcI2C2_Bn.I2C_EV_DMAHandler(cComNode::tenEvent::enEvDmaRxTc);
}

void I2C2_EV_IRQHandler(void)
{
  mcPA00.vSet1();
  mcI2C2_Bn.I2C_EV_IRQHandler();
  mcPA00.vSet0();
}
...
int main(void)
{
  ...
  {
    // RomConst Error
    mcBn.mcAdr.Set(0x1100);
    mcBn.mcStreamSys.mcCmdPort.mcStrPrompt = mcBn.mcAdr.ToString();
    mcBn.mcStreamSys.mcCmdPort.mcStrPrompt += (rsz)": ";
