...
cUiElement                          mc16GuiBase011(&mcMsgBox, &mc16GScreen1);
cUiElement                          mc16GuiBase02(&mcMsgBox, &mc16GScreen1);
cUiElement                          mc16GuiBase021(&mcMsgBox, &mc16GScreen1);
...
#endif
{
  ...
  mc16GuiBase01.bAdd(10, 10, 20, 20, &mc16GuiBase011);

  mc16GuiRoot.bAdd(10,  50, 50, 50, &mc16GuiBase02);
  mc16GuiBase02.bAdd(10, 10, 20, 20, &mc16GuiBase021);
}
