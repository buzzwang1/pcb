...
public:
  ...
  cServo1_Applikation()
  {
    ...
    gpio_mode_set(GPIOB, GPIO_MODE_OUTPUT, GPIO_PUPD_NONE, GPIO_PIN_7); // GND für Poti
    gpio_mode_set(GPIOB, GPIO_MODE_OUTPUT, GPIO_PUPD_NONE, GPIO_PIN_6); // 3V3 für Poti
    ...
    //Sleep
    gpio_mode_set(GPIOA, GPIO_MODE_OUTPUT, GPIO_PUPD_NONE, GPIO_PIN_0); // 1 = enable H-Bridge, 0 = disable H-Bridge
  ...
  void vSetPwm(i16 li16Value)
  {
    ...
    {
      // Set Motor sleep
      gpio_bit_reset(GPIOA, GPIO_PIN_0); // SLEEP
    ...
    {
      // wakeup Motor driver
      gpio_bit_set(GPIOA, GPIO_PIN_0); //SLEEP
    }
  }
  ...
  i16 i16ReadCurrent()
  {
    ...
    if (!gpio_input_bit_get(GPIOA, GPIO_PIN_0)) // Sleep ?
    {
      return 0;
    }
