...
//		delay_ms(200);				  
//	}  	 
 	Show_Str(30,50,200,16,"STM32F4 board",16,0);				    	 
	Show_Str(30,70,200,16,"Show picture program",16,0);				    	 
	Show_Str(30,90,200,16,"KEY0:NEXT KEY1:PREV",16,0);				    	 
	Show_Str(30,110,200,16,"WK_UP:PAUSE",16,0);				    	 
	Show_Str(30,130,200,16,"www.csun.co.jp",16,0);				    	 
	Show_Str(30,150,200,16,"2015/08/15",16,0);
 	while(f_opendir(&picdir,"0:/PICTURE"))//打开图片文件夹
 	{	    
		Show_Str(30,170,240,16,"PICTURE Folder error",16,0);
		delay_ms(200);				  
	...
	picfileinfo.lfname=mymalloc(SRAMIN,picfileinfo.lfsize);	//为长文件缓存区分配内存
 	...
 	{	    
		Show_Str(30,170,240,16,"Memory error!",16,0);
		delay_ms(200);				  
		LCD_Fill(30,170,240,186,WHITE);//清除显示	     
		delay_ms(200);				  
	}  	
	...
	Show_Str(30,170,240,16,"Start showing...",16,0); 
	delay_ms(1500);
	piclib_init();										//初始化画图	   	   
	curindex=0;											//从0开始显示
