...
void ucos_load_main_ui(void)
{
	...
	LCD_ShowString(30,50,200,16,16,"www.csun.co.jp");
   	LCD_ShowString(30,75,200,16,16,"KEY0:DS1 WK_UP:ADJUST");	
   	LCD_ShowString(30,95,200,16,16,"KEY1:SEM and LCD CLEAR"); 
