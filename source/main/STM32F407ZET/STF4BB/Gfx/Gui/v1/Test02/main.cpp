...
ciGraphXY_Channel                     mcChnB(&mc16GRFont, mstChnBPts, 10, null);

stPxli16                            mstChnAPts[10];
ciGraphXY_Channel                     mcChnA(&mc16GRFont, mstChnAPts, 10, &mcChnB);


cUiElement                          mc16GUi1( 30, 30, 320, 220, &mcMsgBox);
cUiElement_TextBox                  mc16GUi2( 20, 15,  45,  40, &mcMsgBox, 16, &mc16GRFont);
cUiElement_iGraphXYBox              mc16GUi2b(20, 15, 250, 200, &mcMsgBox, &mc16GRFont, &mcChnA);
cUiElement                          mc16GUi3( 60, 40, 120,  90, &mcMsgBox);
cUiElement                          mc16GUi4(  0, 10,  10,  20, &mcMsgBox);
cUiElement_Button                   mc16GUi5( 30, 30,  60,  40, &mcMsgBox, 16, &mc16GRFont);
...
void MAIN_vTick10msLp(void)
{
  ...
  if (lui8t == 5)
  {
    ...
    case cAPDS9960::nAPDS9960_DIR_DOWN:
      mc16GRFont.i8PutStringXY(60, 55, "D", &mc16GScreen1);
      break;
    case cAPDS9960::nAPDS9960_DIR_UP:
      mc16GRFont.i8PutStringXY(60, 55, "U", &mc16GScreen1);
      break;
    case cAPDS9960::nAPDS9960_DIR_RIGHT:
      mc16GRFont.i8PutStringXY(60, 55, "R", &mc16GScreen1);
      break;
    case cAPDS9960::nAPDS9960_DIR_LEFT:
      mc16GRFont.i8PutStringXY(60, 55, "L", &mc16GScreen1);
      break;
    default:
      mc16GRFont.i8PutStringXY(60, 55, "-", &mc16GScreen1);
      break;
    }*/
...
void MAIN_vInitSystem(void)
{
  ...
  //mcI2C1 = new cI2cMaster(I2C1, 8);
  //mcAPDS9960 = new cAPDS9960(mcI2C1, nAPDS9960_I2C_ADDR);
