...
#include "stm32f4xx.h" /* for _get_PSP() from core_cm3.h*/
...
int _putc_r(struct _reent * reent, int ch, int *fp)
{
  (void)reent; /* avoid warning */
  (void)fp; /* avoid warning */
