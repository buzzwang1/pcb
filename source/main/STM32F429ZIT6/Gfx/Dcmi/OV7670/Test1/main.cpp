...
int8 i8FlipCol(cBitmap_Bpp16_5R6G5B* lcBm)
{
  uint32 lui32t;
  uint8  lui8Col;

  for (lui32t = 0; lui32t < lcBm->u32Size(); lui32t += 2)
  {
    lui8Col = lcBm->mpui8Data[lui32t];
    lcBm->mpui8Data[lui32t]     = lcBm->mpui8Data[lui32t + 1];
    lcBm->mpui8Data[lui32t + 1] = lui8Col;
  }
  return 0;
}
