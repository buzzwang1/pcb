...
def GenerateRomConst(liBaseAdr, liAdr):
    ...
    lAdr = SetHeader(lAdr, "BnBridge", "STM32F303CCT", "Cortex-M4,Rom 256KB,Ram 48KB",     1,     0x1000, 4*1024,   1,       5,        8,    10,       2,        llstListElements)
    ...
    lAdr = SetPartition(lAdr,   5, "Dummy1",          0,         0,    0x00000000,                                  0,            1, llstListElements)
    lAdr = SetPartition(lAdr,   6, "Dummy2",          0,         0,    0x00000000,                                  0,            1, llstListElements)
    lAdr = SetPartition(lAdr,   7, "Dummy3",          0,         0,    0x00000000,                                  0,            1, llstListElements)
