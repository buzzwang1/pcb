...
set(gen_pkg_name "SysPkgClock")

# List of all source files found in the packages filetree
set (gen_files 
	# List of all source files found in gen_files
	# List of all source files found in master_gen_files
	./_var/master/SysPkgClock.cpp
)
...
set (gen_headers 
	...
	# List of all source files found in master_gen_headers
	./_var/master/SysPkgClock.h
)
...
set (gen_asmfiles 
	...
	# List of all source files found in master_gen_asmfiles
)
...
set (gen_include_directories 
	...
	# List of all source files found in master_gen_include_directories
	./_var/master
)
