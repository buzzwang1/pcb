...
public:
  ...
  bool isChargeNeeded()
  {
    ...
    // Verhalten, wann Laden gestartet wird, 0: Sobald Spannung kleiner ChrgVoltStart, 1: Sobald Eingangsspannung vorhanden",
    if ((u8GetRomConstChrgModeStart() == 1) && (lenSmLipo != enSmStCharged)) return True;
  ...
  bool isChargeRequest()
  {
    return (mu8ChargeRequest > 0);
  }

  void vClearChargeRequest()
  {
    mu8ChargeRequest = 0;
  }

  void vSetChargeRequest()
  {
    mu8ChargeRequest = 1;
  }
