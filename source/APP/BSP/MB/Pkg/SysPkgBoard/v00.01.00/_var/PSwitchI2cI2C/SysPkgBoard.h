...
public:
  ...
  void vSetCh(u8 lu8ChIdx, u8 lu8State)
  {
    tenLipoMonS_States lenState;
    if (lu8State)
    {
      lenState = tenLipoMonS_States::enSmStOn;
    }
    else
    {
      lenState = tenLipoMonS_States::enSmStOff;
    }

    switch (lu8ChIdx)
    {
      case 1: lenSmS[enS_Ch1] = lenState; lcEnCh1.vSet(lu8State); break;
      case 2: lenSmS[enS_Ch2] = lenState; lcEnCh2.vSet(lu8State); break;
      case 3: lenSmS[enS_Ch3] = lenState; lcEnCh3.vSet(lu8State); break;
    }
  }
  ...
  bool bStartupCheck()
  {
    ...
    mu8InaErr = 0;
    lu8InaInitCnt = 0;
    for (u8 lui8t = 0; lui8t < 1 /*mInaCnt*/; lui8t++)
    {
    ...
    if (lu8InaInitCnt == 1 /*mInaCnt*/) return True;
  ...
  bool bCheckStartupInaFirstReadFinished()
  {
    ...
    for (u8 lui8t = 0; lui8t < 1 /*mInaCnt*/; lui8t++)
    {
      for (u8 lui8i = 1; lui8i <= 3; lui8i++)
      {
        if ((mcP[lui8t]->mControl.StartRequest) ||
