...
set(gen_pkg_name "SysPkgBoard")

# List of all source files found in the packages filetree
set (gen_files 
	# List of all source files found in gen_files
	# List of all source files found in PSwitchI2cI2C_gen_files
	./_var/PSwitchI2cI2C/SysPkgBoard.cpp
)
...
set (gen_headers 
	...
	# List of all source files found in PSwitchI2cI2C_gen_headers
	./_var/PSwitchI2cI2C/SysPkgBoard.h
)
...
set (gen_asmfiles 
	...
	# List of all source files found in PSwitchI2cI2C_gen_asmfiles
)
...
set (gen_include_directories 
	...
	# List of all source files found in PSwitchI2cI2C_gen_include_directories
	./_var/PSwitchI2cI2C
)
