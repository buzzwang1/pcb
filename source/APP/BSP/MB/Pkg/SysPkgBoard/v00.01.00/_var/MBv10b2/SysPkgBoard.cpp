...
cSysPkgBoard::cSysPkgBoard()
  : mcWakeupPin(GPIOA_BASE, 0, GPIO_MODE_INPUT, GPIO_NOPULL, GPIO_SPEED_FREQ_VERY_HIGH, 0),
    ...
    mcI2C2_Board(I2C2, &mcI2c2_SCL_Board, &mcI2c2_SDA_Board, DMA1, DMA1_Channel5, DMA1_Channel4),
...
{
  if ((mcSys.mcSMan.mcPowerManager.enSysState == cPowerManager::tenSysStates::nStInit) ||
      (mcSys.mcSMan.mcPowerManager.enSysState == cPowerManager::tenSysStates::nStRun))
  {
