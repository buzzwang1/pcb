...
cSysPkgCom::cSysPkgCom()
  : mcMyBotNetCfg((rsz)RomConst_stDevice_Info->szDevice_Name, RomConst_stDevice_Info->u16BnDeviceId, RomConst_stDevice_Info->u16BnNodeAdr),
    ...
    mcI2C3_BnMaster(I2C3, &mcI2c3_SCL_Bn, &mcI2c3_SDA_Bn, 4, u16GetRomConstBaudDownLink1() * 1000),
    ...
    mcMasterUartMpHdU2(USART2, u16GetRomConstBaudDownLink2() * 1000, &mcU2TxRx, 5),
