...
cSysPkgCom::cSysPkgCom()
  : mcMyBotNetCfg((rsz)RomConst_stDevice_Info->szDevice_Name, RomConst_stDevice_Info->u16BnDeviceId, RomConst_stDevice_Info->u16BnNodeAdr),
    ...
    mcI2C1_BnMaster(I2C1, &mcI2c1_SCL_Bn, &mcI2c1_SDA_Bn, DMA1, DMA1_Channel7, DMA1_Channel6, u16GetRomConstBaudDownLink1() * 1000),
    mcComPort2(38400, GPIO_AF7_USART2, 16, 16),

    mcBn(&mcMyBotNetCfg),

    mcNRF905(0x00010110, 0x00010100),
    mcSideLink(&mcNRF905, &mcBn, False), // False => Ping wird später in System.Init2 gestartet.
    ...
    mcMasterUartMpHdU1(USART1, u16GetRomConstBaudDownLink2() * 1000),
    mcDownLinks_0x1000_to_0x1100(&mcMasterUartMpHdU1),
    mcDownLinks_0x1000_to_0x1200(&mcMasterUartMpHdU1),
    mcDownLinks_0x1000_to_0x1300(&mcMasterUartMpHdU1),
    mcDownLinks_0x1000_to_0x1400(&mcMasterUartMpHdU1),
    mcDownLinks_0x1000_to_0x1500(&mcMasterUartMpHdU1),
    mcDownLinks_0x1000_to_0x1600(&mcMasterUartMpHdU1),
    mcDownLinks_0x1000_to_0x1700(&mcMasterUartMpHdU1),
    mcDownLinks_0x1000_to_0x1800(&mcMasterUartMpHdU1),
...
{
  mcBn.vProcess(1000);
  mcI2C1_BnMaster.vTick1ms();
  mcMasterUartMpHdU1.vTick1ms();
  //#ifdef PCB_PROJECTCFG_Test
    //mcSideLinkBotCom.vTick1ms();
  //#else
  //  mcNRF905.vTick1ms();
  //#endif
}
...
// ---------------------------- RF ---------------------------
  ...
  void EXTI15_10_IRQHandler(void)
  {
    ...
    if(__HAL_GPIO_EXTI_GET_IT(LL_EXTI_LINE_13) != 0x00u)
    {
      ...
      mcSys.mcCom.mcNRF905.IrqHandler(cComNode::tenEvent::enEvUsartExtiP1);
    }
...
void DMA1_Channel2_IRQHandler(void)
{
  ...
  mcSys.mcCom.mcNRF905.IrqHandler(cComNode::tenEvent::enEvDmaRxTc);
...
void DMA1_Channel3_IRQHandler(void)
{
  ...
  mcSys.mcCom.mcNRF905.IrqHandler(cComNode::tenEvent::enEvDmaTxTc);
...
void TIM7_IRQHandler(void)
{
  ...
  if(TIM7->SR & TIM_SR_UIF) // if UIF flag is set
  {
    ...
    mcSys.mcCom.mcNRF905.IrqHandler(cComNode::tenEvent::enEvUsartTimer);
  }
...
void DMA2_Channel7_IRQHandler(void)
{
  ...
  // USART1 RX
  mcSys.mcCom.mcMasterUartMpHdU1.IrqHandler(cComNode::tenEvent::enEvDmaRxTc);
...
void USART1_IRQHandler(void)
{
  ...
  mcSys.mcCom.mcMasterUartMpHdU1.IrqHandler(cComNode::tenEvent::enEvUsartTc);
