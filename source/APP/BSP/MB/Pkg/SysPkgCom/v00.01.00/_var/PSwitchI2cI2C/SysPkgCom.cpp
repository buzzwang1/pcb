...
cSysPkgCom::cSysPkgCom()
  : mcMyBotNetCfg1((rsz)RomConst_stDevice_Info->szDevice_Name, RomConst_stDevice_Info->u16BnDeviceId, RomConst_stDevice_Info->u16BnNodeAdr),
    ...
    mcI2C2_BnMaster(I2C2, &mcI2c2_SCL_BnDl, &mcI2c2_SDA_BnDl, DMA1, DMA1_Channel5, DMA1_Channel4, u16GetRomConstBaudDownLink1() * 1000),
    mcBn(&mcMyBotNetCfg1),
...
{
  //if ((mcBn.mcSpop.isEraseActive()) && (mcEraseActive == 0))
  //{
  //  mcEraseActive = 1;
  //  mcI2C2_BnMaster.vDeInitHw();
  //  mcI2C1_BnSlave.vDeInitHw();
  //}
  //else if ((!mcBn.mcSpop.isEraseActive()) && (mcEraseActive == 1))
  //{
  //  mcEraseActive = 0;
  //  mcI2C2_BnMaster.mError = cComNode::enErNoInit;
  //  mcI2C2_BnMaster.mSm    = cComNode::enStError;
  //  mcI2C2_BnMaster.mu16ReInitTicks_ms      = 1;
  //
  //  mcI2C1_BnSlave.mError = cComNode::enErNoInit;
  //  mcI2C1_BnSlave.mSm    = cComNode::enStError;
  //  mcI2C1_BnSlave.mu16ReInitTicks_ms       = 1;
  //}
