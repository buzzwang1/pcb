      ...
      switch (lpu8PayloadRx[0])
      {
        case 0: // Status
          ...
          if ((lpu8PayloadRx[1] == 0) && (lpu8PayloadRx[2] == 0))
          {
            ...
            lu8Data[ 6] = 0;
            // BT Board Type
            lu8Data[7] = 0; // u8GetRomConstBoardType();
        ...
        case 4: // PoMo Powermodule
          ...
          if ((lpu8PayloadRx[1] == 1) && (lpu8PayloadRx[2] < 1))
          {
            u8 lu8Data[29];
      ...
      switch (lpu8PayloadRx[0])
      {
        case 1: // DateTime
          ...
          case 2: // Power Status
            ...
            if ((lpu8PayloadRx[1] == 0) && (lpu8PayloadRx[2] == 0))
            {
              u8   lu8EnableCh1 = lpu8PayloadRx[3];
              u8   lu8EnableCh2 = lpu8PayloadRx[4];
              u8   lu8EnableCh3 = lpu8PayloadRx[5];
              bool lbActivateOutput = False;

              if (lu8EnableCh1 != 0xFF) {mcSys.mcBoard.mcBoardCntrl.vSetCh(1, lu8EnableCh1); lbActivateOutput = True;}
              if (lu8EnableCh2 != 0xFF) {mcSys.mcBoard.mcBoardCntrl.vSetCh(2, lu8EnableCh2); lbActivateOutput = True;}
              if (lu8EnableCh3 != 0xFF) {mcSys.mcBoard.mcBoardCntrl.vSetCh(3, lu8EnableCh3); lbActivateOutput = True;}
