...
set (gen_files 
	...
	./DiffTimer.cpp
	# List of all source files found in stm32f30x_gen_files
	./_var/stm32f30x/DiffTimerHw.cpp
)
...
set (gen_headers 
	...
	./DiffTimer.h
	# List of all source files found in stm32f30x_gen_headers
	./_var/stm32f30x/DiffTimerHw.h
)
...
set (gen_asmfiles 
	...
	# List of all source files found in stm32f30x_gen_asmfiles
)
...
set (gen_include_directories 
	...
	.
	# List of all source files found in stm32f30x_gen_include_directories
	./_var/stm32f30x
)
