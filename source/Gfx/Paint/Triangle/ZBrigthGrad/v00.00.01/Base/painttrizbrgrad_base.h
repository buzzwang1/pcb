#ifndef __PAINT_TRIANGLE_Z_BRIGHTNESS_GRADIENT_BASE_H__
#define __PAINT_TRIANGLE_Z_BRIGHTNESS_GRADIENT_BASE_H__
...
class cPaintTriZBrigthgrad;
typedef void(cPaintTriZBrigthgrad::*cPaintTriZBrigthgrad_vLineHAbs)(u16);

class cPaintTriZBrigthgrad
{
  public:
    cPaintTriZBrigthgrad_vLineHAbs vLineHAbs;
    ...
    cPaintTriZBrigthgrad(float* lzlfBuffer)
    {
      mcScr     = null;
      mstLeft   = null;
      mstRight  = null;
      ...
      if (lbGetMem)
      {
        ...
        switch (lcScr->mpcBm->u8Type())
        {
          ...
          case BM_BPP16_5R6G5B:
            vLineHAbs =  &cPaintTriZBrigthgrad::BM_BPP16_5R6G5B_vLineHAbs;
            break;
    ...
    void vScanLineAbs(uint8 lu8t1, uint8 lu8t2, tstScanline* lstMem)
    {
      ...
      if (liGfxPosY1 == liGfxPosY2)
      {
        ...
        mstLeft[liGfxIdxY].u8B = mstTri->Dat[lu8t1].u8B;
        mstLeft[liGfxIdxY].fx = mstTri->Dat[lu8t1].fx;
        mstLeft[liGfxIdxY].fiz = mstTri->Dat[lu8t1].fiz;
...
#endif // __PAINT_TRIANGLE_Z_BRIGHTNESS_GRADIENT_BASE_H__
