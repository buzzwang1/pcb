#ifndef _PAINT_TRIANGLE_BASIC_BASE_H__
#define _PAINT_TRIANGLE_BASIC_BASE_H__
...
class cPaintTriBasic;
typedef void(cPaintTriBasic::*cPaintTriBasic_vLineHAbs)(u16);

class cPaintTriBasic
{
  public:
    cPaintTriBasic_vLineHAbs vLineHAbs;
      ...
      if (lbGetMem)
      {
        ...
        switch (lcScr->mpcBm->u8Type())
        {
          ...
          case BM_BPP16_5R6G5B:
            vLineHAbs =  &cPaintTriBasic::BM_BPP16_5R6G5B_vLineHAbs;
            break;
...
#endif // _PAINT_TRIANGLE_BASIC_BASE_H__
