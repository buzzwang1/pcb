...
#ifndef __IGRAPHXY_BASE_H__
#define __IGRAPHXY_BASE_H__
...
#define GRAPHXY_MAX_CHANNELS         64

#define GRAPHXY_MODE_DOTS      0
#define GRAPHXY_MODE_LINES     1

#define IGRAPHXY_INVALID        BM_INVALID
#define IGRAPHXY_FAIL           BM_FAIL
#define IGRAPHXY_OK             BM_OK
#define IGRAPHXY_INLINE         BM_INLINE
...
public:
  ...
  ciGraphXY(cRFont *lpstRFont, GfxInt liGfxWidth, GfxInt liGfxHeight, cScreen *lpstDest)
  : ciGraphXY(lpstRFont, liGfxWidth, liGfxHeight)
  {
    mpstDest = lpstDest;
  }

  ciGraphXY(cRFont *lpstRFont, GfxInt liGfxWidth, GfxInt liGfxHeight)
  {
    ...
    cStrTools::szStrCpy(mszLabelX, "X-Label");
  ...
  BM_INLINE i32 i32YValuetoPixelRelGraph(i16 li16Value, ciGraphXY_Channel* lpcChn)
  {
  ...
  BM_INLINE void vValueToPixelRelGraph(stPxli16* lpstValue, stPxli16* lpstPixel, ciGraphXY_Channel* lpcChn)
  {
    lpstPixel->x = i32XValuetoPixelRelGraph(lpstValue->x);
    lpstPixel->y = i32YValuetoPixelRelGraph(lpstValue->y, lpcChn);
  }

  BM_INLINE void vValueToPixelRelScreen(stPxli16* lpstValue, stPxli16* lpstPixel, ciGraphXY_Channel* lpcChn)
  {
  ...
  BM_INLINE void vValueToPixelAbs(stPxli16* lpstValue, stPxli16* lpstPixel, ciGraphXY_Channel* lpcChn)
  {
  ...
  void vPaint_X_Axis(stPxli16* lpstOffset, ciGraphXY_Channel* lpcChn)
  {    
    int16 li16x;
    int16 li16StartX1;
    int16 li16StartY1;
  ...
  void vPaint_Y_Label(stPxli16* lpstOffset, ciGraphXY_Channel* lpcChn)
  {
    int16 li16StartX1;
    int16 li16StartY1;
    int16 li16StartX2;
  ...
  void vPaint_Y_Raster(stPxli16* lpstOffset, ciGraphXY_Channel* lpcChn)
  {
    if (mi8Grid) // Gitter zeichnen ?    
    {
      int16 li16y;
  ...
  void vPaint_Y_Axis(stPxli16* lpstOffset, ciGraphXY_Channel* lpcChn)
  {
    int16 li16y;
    int16 li16StartX1;
    int16 li16StartY1;
  ...
  void vPaint_i16Channel(stPxli16* lpstOffset, ciGraphXY_Channel* lpcChn, i16 li16Value)
  {
    ...
    {
      vValueToPixelRelGraph(&lpcChn->mpstP[lui16Pos], &lstDestPxl1, lpcChn);

      lpcChn->mpstP[lui16Pos].x -= li16Value;
      ...
      {
        case GRAPHXY_MODE_DOTS:
          mpstDest->vPp(lstDestPxl1.x,
                        lstDestPxl1.y,
                        lpcChn->mui32Col);
          break;

        case GRAPHXY_MODE_LINES:
  ...
  void vPaint(ciGraphXY_Channel* lpcChn, i16 li16Value = 0)
  {
    stPxli16 lstOffset;
    stPxli16 lstOffset2;
    ciGraphXY_Channel* lpcChnTemp;
        ...
        (miGfxGraphWidth > 0))
    {
      ...
      while (lpcChnTemp != null)
      {
        vPaint_i16Channel(&lstOffset, lpcChnTemp, li16Value);
        lpcChnTemp = lpcChnTemp->mcNext;
      }
    }
  }

  void vPaintAndScroll(ciGraphXY_Channel* lpcChn, i16 li16Value)
  {
    if (lpcChn->mu16Count < lpcChn->mu16Size)
    {
      vPaint(lpcChn, 0);
    }
    else
    {
      vPaint(lpcChn, li16Value);
    }
  }
