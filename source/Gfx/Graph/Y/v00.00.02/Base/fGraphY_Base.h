...
#ifndef __FGRAPHY_BASE_H__
#define __FGRAPHY_BASE_H__
...
public:
  ...
  cfGraphY(cRFont *lpstRFont, GfxInt liGfxWidth, GfxInt liGfxHeight, cScreen *lpstDest)
  : cfGraphY(lpstRFont, liGfxWidth, liGfxHeight)
  {
    mpstDest = lpstDest;
  }

  cfGraphY(cRFont *lpstRFont, GfxInt liGfxWidth, GfxInt liGfxHeight)
  {
  ...
  BM_INLINE float fXValuetoPixelRelGraph(float lfValue)
  {
    return (float)(((float)miGfxGraphWidth * (lfValue - mi16SkalXMin)) / (mi16SkalXMax - mi16SkalXMin));
  }

  BM_INLINE float fYValuetoPixelRelGraph(float lfValue, cfGraphY_Channel* lpcChn)
  {
    return ((float)miGfxGraphHeight - (float)(((float)miGfxGraphHeight * (lfValue - lpcChn->mi16SkalYMin)) / (lpcChn->mi16SkalYMax - lpcChn->mi16SkalYMin)));
  }

  BM_INLINE void vValueToPixelRelGraph(stPxlf* lpstValue, stPxlf* lpstPixel, cfGraphY_Channel* lpcChn)
  {
    lpstPixel->x = fXValuetoPixelRelGraph(lpstValue->x);
    lpstPixel->y = fYValuetoPixelRelGraph(lpstValue->y, lpcChn);
  }

  BM_INLINE void vValueToPixelRelScreen(stPxlf* lpstValue, stPxlf* lpstPixel, cfGraphY_Channel* lpcChn)
  {
  ...
  BM_INLINE void vValueToPixelAbs(stPxlf* lpstValue, stPxlf* lpstPixel, cfGraphY_Channel* lpcChn)
  {
  ...
  FRet i8PixelToi16Value(stPxlf* lpstValue, stPxlf* lpstPixel)
  {
    UNUSED(lpstValue);
    UNUSED(lpstPixel);
    /*
  ...
  void vPaint_X_Axis(stPxli16* lpstOffset, cfGraphY_Channel* lpcChn)
  {    
    int16 li16x;
    int16 li16StartX1;
    int16 li16StartY1;
    ...
    // Gitterlinien und Beschriftung
    {
      ...
      for (li16t = 0; li16t <= mi16SkalXCnt; li16t++)
      {
        ...
        mpstRFont->mstStartPos.y = li32PosY + (stStrLen.y + 2);
      ...
      mpstDest->vLineV((i16)((float)li16StartX1 + fXValuetoPixelRelGraph(0)), li16StartY1, li16StartY2, mi32ColLines);
  ...
  void vPaint_Y_Label(stPxli16* lpstOffset, cfGraphY_Channel* lpcChn)
  {
    int16 li16StartX1;
    int16 li16StartY1;
    int16 li16StartX2;
  ...
  void vPaint_Y_Raster(stPxli16* lpstOffset, cfGraphY_Channel* lpcChn)
  {
    if (mi8Grid) // Gitter zeichnen ?    
    {
      int16 li16y;
  ...
  void vPaint_Y_Axis(stPxli16* lpstOffset, cfGraphY_Channel* lpcChn)
  {
    int16 li16y;
    int16 li16StartX1;
    int16 li16StartY1;
    ...
    // Gitterlinien und Beschriftung
    {
      ...
      for (li16t = 0; li16t <= lpcChn->mi16SkalYCnt; li16t++)
      {
        ...
        mpstRFont->mstStartPos.y = li16y + (stStrLen.y / 2);
      ...
      // Y-Achse 
      // Koordinatenkreuz zeichnen;
      mpstDest->vLineH(li16StartX1, li16StartX2, (i16)((float)li16StartY1 + fYValuetoPixelRelGraph(0, lpcChn)), mi32ColLines);
      //mpstDest->vLineV(li16StartX2, li16StartY1, li16StartY2, mi32ColLines);
    }
  }

  void vPaint_i16Channel(stPxli16* lpstOffset, cfGraphY_Channel* lpcChn)
  {
    stPxlf lstSrcPxl1;
    stPxlf lstDestPxl1;
    stPxlf lstDestPxl2;
    ...
    for (lui16Idx = 0; lui16Idx < lpcChn->mu16Count; lui16Idx++)
    {
      ...
      lstSrcPxl1.y = lpcChn->mfP[lui16Pos];
      ...
      switch (lpcChn->mui8DrawMode)
      {
        case GRAPHY_MODE_DOTS:
          mpstDest->vPp((i16)lstDestPxl1.x,
                        (i16)lstDestPxl1.y,
                        lpcChn->mui32Col);
          break;

        case GRAPHY_MODE_LINES:
          mpstDest->vLine((i16)lstDestPxl1.x, (i16)lstDestPxl1.y,
                          (i16)lstDestPxl2.x, (i16)lstDestPxl2.y,
                          lpcChn->mui32Col);
          break;
      }
  ...
  void vPaint(cfGraphY_Channel* lpcChn)
  {
    stPxli16 lstOffset;
    stPxli16 lstOffset2;
    cfGraphY_Channel* lpcChnTemp;
