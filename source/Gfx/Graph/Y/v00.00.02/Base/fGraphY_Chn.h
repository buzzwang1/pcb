#ifndef FGRAPHY_CHANNEL_H
#define FGRAPHY_CHANNEL_H
...
#define FGRAPHY_CHANNEL_DRAWMODE_DOTS  0
#define FGRAPHY_CHANNEL_DRAWMODE_LINES 1

#define FGRAPH_CHANNEL_BUFMODE_UNLIMITED  0
#define FGRAPHY_CHANNEL_BUFMODE_LIMITED    1

class cfGraphY_Channel
{
public: 
  float     *mfP;       // Buffer
  ...
  cfGraphY_Channel* mcNext;

  cfGraphY_Channel(cRFont *lpstRFont, float *lfP, uint16 lui16Size, cfGraphY_Channel* lcNext)
  {
    mpstRFont    = lpstRFont;
    mu16Size     = lui16Size;
    mfP          = lfP;
    mui8BuffMode = FGRAPH_CHANNEL_BUFMODE_UNLIMITED;

    mui32Col     = 0xFFFFFF;
    mui8DrawMode = FGRAPHY_CHANNEL_DRAWMODE_LINES;
  ...
  void vAdd(i16 li16P)
  {
    if (mui8BuffMode == FGRAPH_CHANNEL_BUFMODE_UNLIMITED)
    {
      // store data
      mfP[mu16Inpos] = li16P;
