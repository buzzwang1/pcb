...
class cWorld_3Df_Viewer
{
  ...
  char* toString()
  {
    ...
    mszPos[0] = '<';
    mszPos[1] = 0;
    cStrTools::uixFtoan(mcPos.x, lszValue, 8, 2);cStrTools::szStrCat(mszPos, lszValue);
    cStrTools::szStrCat(mszPos, ",");
    cStrTools::uixFtoan(mcPos.y, lszValue, 8, 2);cStrTools::szStrCat(mszPos, lszValue);
    cStrTools::szStrCat(mszPos, ",");
    cStrTools::uixFtoan(mcPos.z, lszValue, 8, 2);cStrTools::szStrCat(mszPos, lszValue);
    cStrTools::szStrCat(mszPos, ">\n<");

    cStrTools::uixFtoan(mcDirA.x, lszValue, 8, 2);cStrTools::szStrCat(mszPos, lszValue);
    cStrTools::szStrCat(mszPos, ",");
    cStrTools::uixFtoan(mcDirA.y, lszValue, 8, 2);cStrTools::szStrCat(mszPos, lszValue);
    cStrTools::szStrCat(mszPos, ",");
    cStrTools::uixFtoan(mcDirA.z, lszValue, 8, 2);cStrTools::szStrCat(mszPos, lszValue);
    cStrTools::szStrCat(mszPos, ">\n<");

    cStrTools::uixFtoan(mcLookDir.x, lszValue, 8, 2);cStrTools::szStrCat(mszPos, lszValue);
    cStrTools::szStrCat(mszPos, ",");
    cStrTools::uixFtoan(mcLookDir.y, lszValue, 8, 2);cStrTools::szStrCat(mszPos, lszValue);
    cStrTools::szStrCat(mszPos, ",");
    cStrTools::uixFtoan(mcLookDir.z, lszValue, 8, 2);cStrTools::szStrCat(mszPos, lszValue);
    cStrTools::szStrCat(mszPos, ">");
