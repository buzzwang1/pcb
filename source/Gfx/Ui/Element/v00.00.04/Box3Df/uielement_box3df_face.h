...
class cSimple3Df_BaseFace
{
  public:
  uint16 mau16PntIdx[3];
};

class cSimple3Df_Face: public cSimple3Df_BaseFace
{
public:
  cSimple3Df_Face()
  {
...
class cSimple3Df_BaseFace_Data_Tex
{
  public:
    uint32 mu32BaseCol;
...
class cSimple3Df_Face_Data_Tex: public cSimple3Df_BaseFace_Data_Tex
{
  public:
