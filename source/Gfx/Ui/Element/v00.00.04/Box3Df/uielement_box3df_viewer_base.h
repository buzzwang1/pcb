...
class cWorld_3Df_ViewerWorld_Base: public cQSortExt
{
    ...
    : mcQSort(this)
  {
    ...
    macPoints     = (cSimple3Df_Point_Light*)         new cSimple3Df_Point_Light[lpcRefWorld->mu32PointsSize];
    macPoints2D   = (cSimple3Df_2DzPoint*)            new cSimple3Df_2DzPoint[lpcRefWorld->mu32PointsSize];
    macFaces      = (cSimple3Df_Face*)                new cSimple3Df_Face[lpcRefWorld->mu32FacesSize];
    macFaces_Data = (cSimple3Df_Face_Data_Tex_Light*) new cSimple3Df_Face_Data_Tex_Light[lpcRefWorld->mu32FacesSize];
  }
