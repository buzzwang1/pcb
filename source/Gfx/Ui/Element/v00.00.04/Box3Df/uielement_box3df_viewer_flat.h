...
class cWorld_3Df_Viewer_Flat : public cWorld_3Df_ViewerWorld_Base
{
  ...
  void World2Viewer()
  {
    ...
    for (int32 li32i = 0; li32i < mpcRefWorld->mu32FacesCnt; li32i++)
    {
      ...
      lcFace_Data = (cSimple3Df_Face_Data_Tex_Light*)&lcObj->mcFaces_Data[li32i - mpcRefWorld->macFaces[li32i].mpcObjRef->FaceIdx];
