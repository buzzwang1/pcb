...
class cUiElement
{
  public:
    ...
    struct tstStatus
    {
      ...
      u32 Refresh        : 1; // Fensterinhalt/grˆﬂe/position hat sich und muss neu gezeichnet werden
    ...
    virtual void OnAddeded() {}        // Wird aufgerufen, nachdem das Element dazugef¸gt wurde.
