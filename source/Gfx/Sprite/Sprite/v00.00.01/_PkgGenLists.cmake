...
set(gen_pkg_name "gfxsprite")

# List of all source files found in the packages filetree
set (gen_files 
	# List of all source files found in gen_files
	./Base/sprite_base.cpp
	./Sprite_Bpp1_1G_Res8b/v00.00.01/Base/BPP1_1G_Res8b_Sprite_Base.cpp
	./sprite.cpp
)
...
set (gen_headers 
	...
	./Base/SpriteDef.h
	./Base/sprite_base.h
	./Sprite_Bpp1_1G_Res8b/v00.00.01/Base/BPP1_1G_Res8b_Sprite_Base.h
	./sprite.h
)
...
set (gen_include_directories 
	...
	./Base
	./Sprite_Bpp1_1G_Res8b/v00.00.01/Base
	.
)
