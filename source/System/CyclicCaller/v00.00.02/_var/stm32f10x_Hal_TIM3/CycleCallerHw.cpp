...
void TIM3_IRQHandler(void)
{
  if (TIM3->SR & TIM_SR_UIF) // if UIF flag is set
  {
    ...
    CycCall_vMain_Hp_1ms();
  }
}

void CycCallHw_vInit()
{
  ...
  HAL_NVIC_SetPriority(TIM3_IRQn, 15, 8);
  ...
  */
  ...
  TimHandle.Init.Prescaler         = ((cClockInfo::mstClocks.PCLK1_Frequency * 2) / 1000000) - 1;  // 1us
