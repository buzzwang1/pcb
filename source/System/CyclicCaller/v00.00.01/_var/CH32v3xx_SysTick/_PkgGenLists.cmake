...
set (gen_files 
	...
	./CycleCaller.cpp
	# List of all source files found in CH32v3xx_SysTick_gen_files
	./_var/CH32v3xx_SysTick/CycleCallerHw.cpp
)
...
set (gen_headers 
	...
	./CycleCaller.h
	# List of all source files found in CH32v3xx_SysTick_gen_headers
	./_var/CH32v3xx_SysTick/CycleCallerHw.h
)
...
set (gen_asmfiles 
	...
	# List of all source files found in CH32v3xx_SysTick_gen_asmfiles
)
...
set (gen_include_directories 
	...
	.
	# List of all source files found in CH32v3xx_SysTick_gen_include_directories
	./_var/CH32v3xx_SysTick
)
