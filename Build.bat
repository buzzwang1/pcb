...
:: 0 args given: project=*           selectionmode=select      => User can select from all available projects
...
:: ToolCaller Commands 
set TcCmds=projects/ExportCfgCm
set TcCmds=%TcCmds%;Projects/Packages/UpdateGenLists
set TcCmds=%TcCmds%;maketool/generate/call
set TcCmds=%TcCmds%;maketool/build/call
set TcCmds=%TcCmds%;reports/memory/call
